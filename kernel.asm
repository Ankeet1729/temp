...
801003c4:	e8 e7 02 00 00       	call   801006b0 <cprintf>
  cprintf("\n");
801003c9:	c7 04 24 e3 7c 10 80 	movl   $0x80107ce3,(%esp)
...
80100d7e:	8b 7f 0c             	mov    0xc(%edi),%edi
  curproc->sz = sz;
80100d81:	89 70 08             	mov    %esi,0x8(%eax)
  curproc->pgdir = pgdir;
80100d84:	89 48 0c             	mov    %ecx,0xc(%eax)
...
80100d92:	89 50 38             	mov    %edx,0x38(%eax)
  curproc->tf->esp = sp;
80100d95:	8b 41 20             	mov    0x20(%ecx),%eax
80100d98:	89 58 44             	mov    %ebx,0x44(%eax)
  switchuvm(curproc);
80100d9b:	89 0c 24             	mov    %ecx,(%esp)
80100d9e:	e8 ed 5e 00 00       	call   80106c90 <switchuvm>
  freevm(oldpgdir);
80100da3:	89 3c 24             	mov    %edi,(%esp)
80100da6:	e8 a5 62 00 00       	call   80107050 <freevm>
  return 0;
...
80100dbd:	68 e1 73 10 80       	push   $0x801073e1
...
80101d92:	89 df                	mov    %ebx,%edi
    ip = idup(myproc()->cwd);
80101d94:	8b 70 70             	mov    0x70(%eax),%esi
  acquire(&icache.lock);
...
80102020:	68 ba 7a 10 80       	push   $0x80107aba
...
80103002:	e8 99 2b 00 00       	call   80105ba0 <idtinit>
...
8010308d:	e8 3e 08 00 00       	call   801038d0 <pinit>
  tvinit();        // trap vectors
80103092:	e8 89 2a 00 00       	call   80105b20 <tvinit>
  binit();         // buffer cache
...
801035fd:	8b 48 2c             	mov    0x2c(%eax),%ecx
...
801036dd:	8b 48 2c             	mov    0x2c(%eax),%ecx
...
801037ce:	83 ec 0c             	sub    $0xc,%esp
  p->state = EMBRYO;
801037d1:	c7 43 14 01 00 00 00 	movl   $0x1,0x14(%ebx)
  p->nswtch=0;
801037d8:	c7 43 04 00 00 00 00 	movl   $0x0,0x4(%ebx)
  p->pid = nextpid++;
801037df:	89 43 18             	mov    %eax,0x18(%ebx)
801037e2:	8d 50 01             	lea    0x1(%eax),%edx
  p->priority=1000;
801037e5:	c7 03 e8 03 00 00    	movl   $0x3e8,(%ebx)
  release(&ptable.lock);
801037eb:	68 20 2d 11 80       	push   $0x80112d20
  p->pid = nextpid++;
801037f0:	89 15 04 a0 10 80    	mov    %edx,0x8010a004
  release(&ptable.lock);
801037f6:	e8 c5 0f 00 00       	call   801047c0 <release>

  // Allocate kernel stack.
  if((p->kstack = kalloc()) == 0){
801037fb:	e8 30 ee ff ff       	call   80102630 <kalloc>
80103800:	83 c4 10             	add    $0x10,%esp
80103803:	89 43 10             	mov    %eax,0x10(%ebx)
80103806:	85 c0                	test   %eax,%eax
80103808:	74 57                	je     80103861 <allocproc+0xd1>
    return 0;
  }
...
80103813:	05 9c 0f 00 00       	add    $0xf9c,%eax
  sp -= sizeof *p->tf;
80103818:	89 53 20             	mov    %edx,0x20(%ebx)
  *(uint*)sp = (uint)trapret;
8010381b:	c7 40 14 0b 5b 10 80 	movl   $0x80105b0b,0x14(%eax)
  p->context = (struct context*)sp;
80103822:	89 43 24             	mov    %eax,0x24(%ebx)
  memset(p->context, 0, sizeof *p->context);
80103825:	6a 14                	push   $0x14
80103827:	6a 00                	push   $0x0
80103829:	50                   	push   %eax
8010382a:	e8 e1 0f 00 00       	call   80104810 <memset>
  p->context->eip = (uint)forkret;
8010382f:	8b 43 24             	mov    0x24(%ebx),%eax
...
8010383e:	8b 5d fc             	mov    -0x4(%ebp),%ebx
80103841:	c9                   	leave  
80103842:	c3                   	ret    
...
80103852:	e8 69 0f 00 00       	call   801047c0 <release>
}
...
80103860:	c3                   	ret    
    p->state = UNUSED;
80103861:	c7 43 14 00 00 00 00 	movl   $0x0,0x14(%ebx)
    return 0;
...
8010388f:	e8 2c 0f 00 00       	call   801047c0 <release>
...
801038e4:	e8 97 0c 00 00       	call   80104580 <initlock>
}
...
80103988:	83 ec 04             	sub    $0x4,%esp
  pushcli();
8010398b:	e8 70 0c 00 00       	call   80104600 <pushcli>
  c = mycpu();
80103990:	e8 5b ff ff ff       	call   801038f0 <mycpu>
  p = c->proc;
80103995:	8b 98 ac 00 00 00    	mov    0xac(%eax),%ebx
  popcli();
8010399b:	e8 b0 0c 00 00       	call   80104650 <popcli>
}
...
801039cc:	89 43 0c             	mov    %eax,0xc(%ebx)
801039cf:	85 c0                	test   %eax,%eax
801039d1:	0f 84 be 00 00 00    	je     80103a95 <userinit+0xe5>
...
801039ea:	83 c4 0c             	add    $0xc,%esp
  p->sz = PGSIZE;
801039ed:	c7 43 08 00 10 00 00 	movl   $0x1000,0x8(%ebx)
  memset(p->tf, 0, sizeof(*p->tf));
801039f4:	6a 4c                	push   $0x4c
801039f6:	6a 00                	push   $0x0
801039f8:	ff 73 20             	pushl  0x20(%ebx)
801039fb:	e8 10 0e 00 00       	call   80104810 <memset>
  p->tf->cs = (SEG_UCODE << 3) | DPL_USER;
80103a00:	8b 43 20             	mov    0x20(%ebx),%eax
80103a03:	ba 1b 00 00 00       	mov    $0x1b,%edx
  safestrcpy(p->name, "initcode", sizeof(p->name));
80103a08:	83 c4 0c             	add    $0xc,%esp
  p->tf->ds = (SEG_UDATA << 3) | DPL_USER;
80103a0b:	b9 23 00 00 00       	mov    $0x23,%ecx
  p->tf->cs = (SEG_UCODE << 3) | DPL_USER;
80103a10:	66 89 50 3c          	mov    %dx,0x3c(%eax)
  p->tf->ds = (SEG_UDATA << 3) | DPL_USER;
80103a14:	8b 43 20             	mov    0x20(%ebx),%eax
80103a17:	66 89 48 2c          	mov    %cx,0x2c(%eax)
  p->tf->es = p->tf->ds;
80103a1b:	8b 43 20             	mov    0x20(%ebx),%eax
80103a1e:	0f b7 50 2c          	movzwl 0x2c(%eax),%edx
80103a22:	66 89 50 28          	mov    %dx,0x28(%eax)
  p->tf->ss = p->tf->ds;
80103a26:	8b 43 20             	mov    0x20(%ebx),%eax
80103a29:	0f b7 50 2c          	movzwl 0x2c(%eax),%edx
80103a2d:	66 89 50 48          	mov    %dx,0x48(%eax)
  p->tf->eflags = FL_IF;
80103a31:	8b 43 20             	mov    0x20(%ebx),%eax
80103a34:	c7 40 40 00 02 00 00 	movl   $0x200,0x40(%eax)
  p->tf->esp = PGSIZE;
80103a3b:	8b 43 20             	mov    0x20(%ebx),%eax
80103a3e:	c7 40 44 00 10 00 00 	movl   $0x1000,0x44(%eax)
  p->tf->eip = 0;  // beginning of initcode.S
80103a45:	8b 43 20             	mov    0x20(%ebx),%eax
80103a48:	c7 40 38 00 00 00 00 	movl   $0x0,0x38(%eax)
  safestrcpy(p->name, "initcode", sizeof(p->name));
80103a4f:	8d 43 74             	lea    0x74(%ebx),%eax
80103a52:	6a 10                	push   $0x10
80103a54:	68 d0 78 10 80       	push   $0x801078d0
80103a59:	50                   	push   %eax
80103a5a:	e8 71 0f 00 00       	call   801049d0 <safestrcpy>
  p->cwd = namei("/");
80103a5f:	c7 04 24 d9 78 10 80 	movl   $0x801078d9,(%esp)
80103a66:	e8 c5 e5 ff ff       	call   80102030 <namei>
80103a6b:	89 43 70             	mov    %eax,0x70(%ebx)
  acquire(&ptable.lock);
80103a6e:	c7 04 24 20 2d 11 80 	movl   $0x80112d20,(%esp)
80103a75:	e8 86 0c 00 00       	call   80104700 <acquire>
  p->state = RUNNABLE;
80103a7a:	c7 43 14 03 00 00 00 	movl   $0x3,0x14(%ebx)
  release(&ptable.lock);
80103a81:	c7 04 24 20 2d 11 80 	movl   $0x80112d20,(%esp)
80103a88:	e8 33 0d 00 00       	call   801047c0 <release>
}
...
80103a98:	68 b7 78 10 80       	push   $0x801078b7
...
80103ab9:	8b 75 08             	mov    0x8(%ebp),%esi
  pushcli();
80103abc:	e8 3f 0b 00 00       	call   80104600 <pushcli>
  c = mycpu();
80103ac1:	e8 2a fe ff ff       	call   801038f0 <mycpu>
  p = c->proc;
80103ac6:	8b 98 ac 00 00 00    	mov    0xac(%eax),%ebx
  popcli();
80103acc:	e8 7f 0b 00 00       	call   80104650 <popcli>
  sz = curproc->sz;
80103ad1:	8b 43 08             	mov    0x8(%ebx),%eax
  if(n > 0){
80103ad4:	85 f6                	test   %esi,%esi
80103ad6:	7f 20                	jg     80103af8 <growproc+0x48>
  } else if(n < 0){
80103ad8:	75 3e                	jne    80103b18 <growproc+0x68>
  switchuvm(curproc);
80103ada:	83 ec 0c             	sub    $0xc,%esp
  curproc->sz = sz;
80103add:	89 43 08             	mov    %eax,0x8(%ebx)
  switchuvm(curproc);
80103ae0:	53                   	push   %ebx
80103ae1:	e8 aa 31 00 00       	call   80106c90 <switchuvm>
  return 0;
...
80103aff:	ff 73 0c             	pushl  0xc(%ebx)
80103b02:	e8 e9 33 00 00       	call   80106ef0 <allocuvm>
80103b07:	83 c4 10             	add    $0x10,%esp
80103b0a:	85 c0                	test   %eax,%eax
80103b0c:	75 cc                	jne    80103ada <growproc+0x2a>
      return -1;
80103b0e:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80103b13:	eb d6                	jmp    80103aeb <growproc+0x3b>
...
80103b1f:	ff 73 0c             	pushl  0xc(%ebx)
80103b22:	e8 f9 34 00 00       	call   80107020 <deallocuvm>
80103b27:	83 c4 10             	add    $0x10,%esp
80103b2a:	85 c0                	test   %eax,%eax
80103b2c:	75 ac                	jne    80103ada <growproc+0x2a>
80103b2e:	eb de                	jmp    80103b0e <growproc+0x5e>
...
80103b3a:	83 ec 1c             	sub    $0x1c,%esp
  pushcli();
80103b3d:	e8 be 0a 00 00       	call   80104600 <pushcli>
  c = mycpu();
80103b42:	e8 a9 fd ff ff       	call   801038f0 <mycpu>
  p = c->proc;
80103b47:	8b 98 ac 00 00 00    	mov    0xac(%eax),%ebx
  popcli();
80103b4d:	e8 fe 0a 00 00       	call   80104650 <popcli>
  if((np = allocproc()) == 0){
80103b52:	e8 39 fc ff ff       	call   80103790 <allocproc>
80103b57:	89 45 e4             	mov    %eax,-0x1c(%ebp)
80103b5a:	85 c0                	test   %eax,%eax
80103b5c:	0f 84 c3 00 00 00    	je     80103c25 <fork+0xf5>
  if((np->pgdir = copyuvm(curproc->pgdir, curproc->sz)) == 0){
80103b62:	83 ec 08             	sub    $0x8,%esp
80103b65:	ff 73 08             	pushl  0x8(%ebx)
80103b68:	89 c7                	mov    %eax,%edi
80103b6a:	ff 73 0c             	pushl  0xc(%ebx)
80103b6d:	e8 2e 36 00 00       	call   801071a0 <copyuvm>
80103b72:	83 c4 10             	add    $0x10,%esp
80103b75:	89 47 0c             	mov    %eax,0xc(%edi)
80103b78:	85 c0                	test   %eax,%eax
80103b7a:	0f 84 ac 00 00 00    	je     80103c2c <fork+0xfc>
  np->sz = curproc->sz;
80103b80:	8b 43 08             	mov    0x8(%ebx),%eax
80103b83:	8b 4d e4             	mov    -0x1c(%ebp),%ecx
80103b86:	89 41 08             	mov    %eax,0x8(%ecx)
  *np->tf = *curproc->tf;
80103b89:	8b 79 20             	mov    0x20(%ecx),%edi
  np->parent = curproc;
80103b8c:	89 c8                	mov    %ecx,%eax
80103b8e:	89 59 1c             	mov    %ebx,0x1c(%ecx)
  *np->tf = *curproc->tf;
80103b91:	b9 13 00 00 00       	mov    $0x13,%ecx
80103b96:	8b 73 20             	mov    0x20(%ebx),%esi
80103b99:	f3 a5                	rep movsl %ds:(%esi),%es:(%edi)
  for(i = 0; i < NOFILE; i++)
80103b9b:	31 f6                	xor    %esi,%esi
  np->tf->eax = 0;
80103b9d:	8b 40 20             	mov    0x20(%eax),%eax
80103ba0:	c7 40 1c 00 00 00 00 	movl   $0x0,0x1c(%eax)
  for(i = 0; i < NOFILE; i++)
...
80103bbc:	e8 af d2 ff ff       	call   80100e70 <filedup>
...
80103bd6:	ff 73 70             	pushl  0x70(%ebx)
  safestrcpy(np->name, curproc->name, sizeof(curproc->name));
80103bd9:	83 c3 74             	add    $0x74,%ebx
  np->cwd = idup(curproc->cwd);
80103bdc:	e8 4f db ff ff       	call   80101730 <idup>
...
80103bf1:	e8 da 0d 00 00       	call   801049d0 <safestrcpy>
  pid = np->pid;
80103bf6:	8b 5f 18             	mov    0x18(%edi),%ebx
  acquire(&ptable.lock);
80103bf9:	c7 04 24 20 2d 11 80 	movl   $0x80112d20,(%esp)
80103c00:	e8 fb 0a 00 00       	call   80104700 <acquire>
  np->state = RUNNABLE;
80103c05:	c7 47 14 03 00 00 00 	movl   $0x3,0x14(%edi)
  release(&ptable.lock);
80103c0c:	c7 04 24 20 2d 11 80 	movl   $0x80112d20,(%esp)
80103c13:	e8 a8 0b 00 00       	call   801047c0 <release>
  return pid;
...
80103c32:	ff 73 10             	pushl  0x10(%ebx)
80103c35:	e8 36 e8 ff ff       	call   80102470 <kfree>
    np->kstack = 0;
80103c3a:	c7 43 10 00 00 00 00 	movl   $0x0,0x10(%ebx)
    return -1;
80103c41:	83 c4 10             	add    $0x10,%esp
    np->state = UNUSED;
80103c44:	c7 43 14 00 00 00 00 	movl   $0x0,0x14(%ebx)
    return -1;
...
80103c6a:	83 ec 0c             	sub    $0xc,%esp
  struct cpu *c = mycpu();
80103c6d:	e8 7e fc ff ff       	call   801038f0 <mycpu>
  c->proc = 0;
...
80103ca4:	75 37                	jne    80103cdd <scheduler+0x7d>
      switchuvm(p);
...
80103cb0:	e8 db 2f 00 00       	call   80106c90 <switchuvm>
...
80103cba:	57                   	push   %edi
      p->nswtch++;
80103cbb:	83 43 04 01          	addl   $0x1,0x4(%ebx)
      p->state = RUNNING;
80103cbf:	c7 43 14 04 00 00 00 	movl   $0x4,0x14(%ebx)
      swtch(&(c->scheduler), p->context);
80103cc6:	e8 68 0d 00 00       	call   80104a33 <swtch>
      switchkvm();
80103ccb:	e8 a0 2f 00 00       	call   80106c70 <switchkvm>
      c->proc = 0;
80103cd0:	83 c4 10             	add    $0x10,%esp
80103cd3:	c7 86 ac 00 00 00 00 	movl   $0x0,0xac(%esi)
80103cda:	00 00 00 
    for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
80103cdd:	81 c3 84 00 00 00    	add    $0x84,%ebx
80103ce3:	81 fb 54 4e 11 80    	cmp    $0x80114e54,%ebx
80103ce9:	75 b5                	jne    80103ca0 <scheduler+0x40>
    release(&ptable.lock);
80103ceb:	83 ec 0c             	sub    $0xc,%esp
80103cee:	68 20 2d 11 80       	push   $0x80112d20
80103cf3:	e8 c8 0a 00 00       	call   801047c0 <release>
    sti();
80103cf8:	83 c4 10             	add    $0x10,%esp
80103cfb:	eb 8b                	jmp    80103c88 <scheduler+0x28>
...
80103d09:	e8 f2 08 00 00       	call   80104600 <pushcli>
  c = mycpu();
80103d0e:	e8 dd fb ff ff       	call   801038f0 <mycpu>
  p = c->proc;
...
80103d30:	74 4f                	je     80103d81 <sched+0x81>
  if(mycpu()->ncli != 1)
80103d32:	e8 b9 fb ff ff       	call   801038f0 <mycpu>
...
80103d4b:	75 41                	jne    80103d8e <sched+0x8e>
  intena = mycpu()->intena;
80103d4d:	e8 9e fb ff ff       	call   801038f0 <mycpu>
  swtch(&p->context, mycpu()->scheduler);
80103d52:	83 c3 24             	add    $0x24,%ebx
  intena = mycpu()->intena;
80103d55:	8b b0 a8 00 00 00    	mov    0xa8(%eax),%esi
  swtch(&p->context, mycpu()->scheduler);
80103d5b:	e8 90 fb ff ff       	call   801038f0 <mycpu>
...
80103d67:	e8 c7 0c 00 00       	call   80104a33 <swtch>
  mycpu()->intena = intena;
80103d6c:	e8 7f fb ff ff       	call   801038f0 <mycpu>
}
...
80103dcd:	e8 2e 08 00 00       	call   80104600 <pushcli>
  c = mycpu();
80103dd2:	e8 19 fb ff ff       	call   801038f0 <mycpu>
  p = c->proc;
...
80103ee7:	68 28 79 10 80       	push   $0x80107928
80103eec:	e8 9f c4 ff ff       	call   80100390 <panic>
    panic("init exiting");
80103ef1:	83 ec 0c             	sub    $0xc,%esp
80103ef4:	68 1b 79 10 80       	push   $0x8010791b
...
80103f10:	e8 eb 07 00 00       	call   80104700 <acquire>
  pushcli();
80103f15:	e8 e6 06 00 00       	call   80104600 <pushcli>
  c = mycpu();
80103f1a:	e8 d1 f9 ff ff       	call   801038f0 <mycpu>
  p = c->proc;
80103f1f:	8b 98 ac 00 00 00    	mov    0xac(%eax),%ebx
  popcli();
80103f25:	e8 26 07 00 00       	call   80104650 <popcli>
...
80103f3d:	e8 7e 08 00 00       	call   801047c0 <release>
}
...
80103f60:	8b 75 0c             	mov    0xc(%ebp),%esi
  pushcli();
80103f63:	e8 98 06 00 00       	call   80104600 <pushcli>
  c = mycpu();
80103f68:	e8 83 f9 ff ff       	call   801038f0 <mycpu>
  p = c->proc;
80103f6d:	8b 98 ac 00 00 00    	mov    0xac(%eax),%ebx
  popcli();
80103f73:	e8 d8 06 00 00       	call   80104650 <popcli>
  if(p == 0)
...
80103f94:	e8 67 07 00 00       	call   80104700 <acquire>
    release(lk);
80103f99:	89 34 24             	mov    %esi,(%esp)
80103f9c:	e8 1f 08 00 00       	call   801047c0 <release>
  p->chan = chan;
...
80103fbe:	e8 fd 07 00 00       	call   801047c0 <release>
    acquire(lk);
...
80103fcf:	5d                   	pop    %ebp
    acquire(lk);
80103fd0:	e9 2b 07 00 00       	jmp    80104700 <acquire>
...
80103ff9:	68 3a 79 10 80       	push   $0x8010793a
80103ffe:	e8 8d c3 ff ff       	call   80100390 <panic>
    panic("sleep");
80104003:	83 ec 0c             	sub    $0xc,%esp
80104006:	68 34 79 10 80       	push   $0x80107934
...
80104018:	53                   	push   %ebx
  pushcli();
80104019:	e8 e2 05 00 00       	call   80104600 <pushcli>
  c = mycpu();
8010401e:	e8 cd f8 ff ff       	call   801038f0 <mycpu>
  p = c->proc;
80104023:	8b b0 ac 00 00 00    	mov    0xac(%eax),%esi
  popcli();
80104029:	e8 22 06 00 00       	call   80104650 <popcli>
  acquire(&ptable.lock);
8010402e:	83 ec 0c             	sub    $0xc,%esp
80104031:	68 20 2d 11 80       	push   $0x80112d20
80104036:	e8 c5 06 00 00       	call   80104700 <acquire>
...
801040b2:	c7 43 10 00 00 00 00 	movl   $0x0,0x10(%ebx)
        freevm(p->pgdir);
801040b9:	e8 92 2f 00 00       	call   80107050 <freevm>
        release(&ptable.lock);
...
801040de:	c7 43 14 00 00 00 00 	movl   $0x0,0x14(%ebx)
        release(&ptable.lock);
801040e5:	e8 d6 06 00 00       	call   801047c0 <release>
        return pid;
...
80104103:	e8 b8 06 00 00       	call   801047c0 <release>
      return -1;
...
80104123:	e8 d8 05 00 00       	call   80104700 <acquire>
...
8010416c:	c9                   	leave  
  release(&ptable.lock);
8010416d:	e9 4e 06 00 00       	jmp    801047c0 <release>
...
80104193:	e8 68 05 00 00       	call   80104700 <acquire>
...
801041d5:	e8 e6 05 00 00       	call   801047c0 <release>
      return 0;
    }
  }
  release(&ptable.lock);
...
801041f0:	e8 cb 05 00 00       	call   801047c0 <release>
}
...
80104233:	68 e3 7c 10 80       	push   $0x80107ce3
...
80104257:	74 e7                	je     80104240 <procdump+0x30>
      state = "???";
80104259:	ba 4b 79 10 80       	mov    $0x8010794b,%edx
    if(p->state >= 0 && p->state < NELEM(states) && states[p->state])
8010425e:	83 f8 05             	cmp    $0x5,%eax
80104261:	77 11                	ja     80104274 <procdump+0x64>
80104263:	8b 14 85 ac 79 10 80 	mov    -0x7fef8654(,%eax,4),%edx
      state = "???";
8010426a:	b8 4b 79 10 80       	mov    $0x8010794b,%eax
...
80104279:	68 4f 79 10 80       	push   $0x8010794f
...
801042a0:	e8 fb 02 00 00       	call   801045a0 <getcallerpcs>
      for(i=0; i<10 && pc[i] != 0; i++)
...
801042c1:	68 a1 73 10 80       	push   $0x801073a1
...
80104302:	e8 f9 03 00 00       	call   80104700 <acquire>
80104307:	83 c4 10             	add    $0x10,%esp
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++)
8010430a:	b8 54 2d 11 80       	mov    $0x80112d54,%eax
8010430f:	90                   	nop
    {
      if(p->state != UNUSED)
      numProc++;
80104310:	83 78 14 01          	cmpl   $0x1,0x14(%eax)
80104314:	83 db ff             	sbb    $0xffffffff,%ebx
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++)
80104317:	05 84 00 00 00       	add    $0x84,%eax
8010431c:	3d 54 4e 11 80       	cmp    $0x80114e54,%eax
80104321:	75 ed                	jne    80104310 <getNumProc+0x20>
    }
  release(&ptable.lock);
...
{
8010434a:	83 ec 10             	sub    $0x10,%esp

  acquire(&ptable.lock);
8010434d:	68 20 2d 11 80       	push   $0x80112d20
80104352:	e8 a9 03 00 00       	call   80104700 <acquire>
80104357:	83 c4 10             	add    $0x10,%esp
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++)
8010435a:	b8 54 2d 11 80       	mov    $0x80112d54,%eax
8010435f:	90                   	nop
    {
      if(p->pid > maxPid)
80104360:	8b 50 18             	mov    0x18(%eax),%edx
80104363:	39 d3                	cmp    %edx,%ebx
80104365:	0f 4c da             	cmovl  %edx,%ebx
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++)
80104368:	05 84 00 00 00       	add    $0x84,%eax
8010436d:	3d 54 4e 11 80       	cmp    $0x80114e54,%eax
80104372:	75 ec                	jne    80104360 <getMaxPid+0x20>
      maxPid=p->pid;
    }
  release(&ptable.lock);
80104374:	83 ec 0c             	sub    $0xc,%esp
80104377:	68 20 2d 11 80       	push   $0x80112d20
8010437c:	e8 3f 04 00 00       	call   801047c0 <release>

  return maxPid;
}
80104381:	89 d8                	mov    %ebx,%eax
...
80104399:	53                   	push   %ebx
  ...
  acquire(&ptable.lock);
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++)
8010439a:	bb 54 2d 11 80       	mov    $0x80112d54,%ebx
{
8010439f:	83 ec 18             	sub    $0x18,%esp
801043a2:	8b 75 08             	mov    0x8(%ebp),%esi
801043a5:	8b 7d 0c             	mov    0xc(%ebp),%edi
  acquire(&ptable.lock);
801043a8:	68 20 2d 11 80       	push   $0x80112d20
801043ad:	e8 4e 03 00 00       	call   80104700 <acquire>
801043b2:	83 c4 10             	add    $0x10,%esp
801043b5:	eb 17                	jmp    801043ce <getProcInfo+0x3e>
801043b7:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
801043be:	66 90                	xchg   %ax,%ax
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++)
801043c0:	81 c3 84 00 00 00    	add    $0x84,%ebx
801043c6:	81 fb 54 4e 11 80    	cmp    $0x80114e54,%ebx
801043cc:	74 05                	je     801043d3 <getProcInfo+0x43>
    {
      if(p->pid == pid)
801043ce:	39 73 18             	cmp    %esi,0x18(%ebx)
801043d1:	75 ed                	jne    801043c0 <getProcInfo+0x30>
      break;
    }
  release(&ptable.lock);
801043d3:	83 ec 0c             	sub    $0xc,%esp
801043d6:	68 20 2d 11 80       	push   $0x80112d20
801043db:	e8 e0 03 00 00       	call   801047c0 <release>
...
801043e3:	83 c4 10             	add    $0x10,%esp
  info->psize = p->sz;
801043e6:	89 47 04             	mov    %eax,0x4(%edi)
  info->ppid = p->parent->pid;

  else
  info->ppid=0;
801043e9:	31 c0                	xor    %eax,%eax
  if(p->pid != 1)
801043eb:	83 7b 18 01          	cmpl   $0x1,0x18(%ebx)
801043ef:	74 06                	je     801043f7 <getProcInfo+0x67>
  info->ppid = p->parent->pid;
801043f1:	8b 43 1c             	mov    0x1c(%ebx),%eax
801043f4:	8b 40 18             	mov    0x18(%eax),%eax
801043f7:	89 07                	mov    %eax,(%edi)
  info->numberContextSwitches = p->nswtch;
801043f9:	8b 43 04             	mov    0x4(%ebx),%eax
801043fc:	89 47 08             	mov    %eax,0x8(%edi)

  return 0;
}
801043ff:	8d 65 f4             	lea    -0xc(%ebp),%esp
80104402:	31 c0                	xor    %eax,%eax
80104404:	5b                   	pop    %ebx
80104405:	5e                   	pop    %esi
80104406:	5f                   	pop    %edi
80104407:	5d                   	pop    %ebp
...
80104418:	83 ec 04             	sub    $0x4,%esp
  pushcli();
8010441b:	e8 e0 01 00 00       	call   80104600 <pushcli>
  c = mycpu();
80104420:	e8 cb f4 ff ff       	call   801038f0 <mycpu>
  p = c->proc;
80104425:	8b 98 ac 00 00 00    	mov    0xac(%eax),%ebx
  popcli();
8010442b:	e8 20 02 00 00       	call   80104650 <popcli>
  // return;
  myproc()->priority = priority;
80104430:	8b 45 08             	mov    0x8(%ebp),%eax
80104433:	89 03                	mov    %eax,(%ebx)
}
...
8010444e:	68 c4 79 10 80       	push   $0x801079c4
...
801044ad:	e8 9e fa ff ff       	call   80103f50 <sleep>
  while (lk->locked) {
...
801044bb:	c7 03 01 00 00 00    	movl   $0x1,(%ebx)
  lk->pid = myproc()->pid;
801044c1:	e8 ba f4 ff ff       	call   80103980 <myproc>
...
80104508:	e8 03 fc ff ff       	call   80104110 <wakeup>
  release(&lk->lk);
...
80104563:	e8 18 f4 ff ff       	call   80103980 <myproc>
80104568:	39 58 18             	cmp    %ebx,0x18(%eax)
...
8010467f:	c3                   	ret    
  if(mycpu()->ncli == 0 && mycpu()->intena)
80104680:	e8 6b f2 ff ff       	call   801038f0 <mycpu>
...
80104695:	68 cf 79 10 80       	push   $0x801079cf
8010469a:	e8 f1 bc ff ff       	call   80100390 <panic>
    panic("popcli");
8010469f:	83 ec 0c             	sub    $0xc,%esp
801046a2:	68 e6 79 10 80       	push   $0x801079e6
...
801046db:	e8 10 f2 ff ff       	call   801038f0 <mycpu>
...
80104744:	e8 a7 f1 ff ff       	call   801038f0 <mycpu>
...
801047a7:	68 ed 79 10 80       	push   $0x801079ed
...
80104800:	68 f5 79 10 80       	push   $0x801079f5
...
80104a66:	39 d8                	cmp    %ebx,%eax
80104a68:	76 16                	jbe    80104a80 <fetchint+0x30>
80104a6a:	8d 53 04             	lea    0x4(%ebx),%edx
80104a6d:	39 d0                	cmp    %edx,%eax
80104a6f:	72 0f                	jb     80104a80 <fetchint+0x30>
    return -1;
  *ip = *(int*)(addr);
...
80104a7a:	83 c4 04             	add    $0x4,%esp
80104a7d:	5b                   	pop    %ebx
80104a7e:	5d                   	pop    %ebp
80104a7f:	c3                   	ret    
    return -1;
80104a80:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80104a85:	eb f3                	jmp    80104a7a <fetchint+0x2a>
...
80104a9e:	e8 dd ee ff ff       	call   80103980 <myproc>
  ...
  if(addr >= curproc->sz)
80104aa3:	39 58 08             	cmp    %ebx,0x8(%eax)
80104aa6:	76 30                	jbe    80104ad8 <fetchstr+0x48>
    return -1;
  *pp = (char*)addr;
80104aa8:	8b 55 0c             	mov    0xc(%ebp),%edx
80104aab:	89 1a                	mov    %ebx,(%edx)
  ep = (char*)curproc->sz;
80104aad:	8b 50 08             	mov    0x8(%eax),%edx
  for(s = *pp; s < ep; s++){
80104ab0:	39 d3                	cmp    %edx,%ebx
80104ab2:	73 24                	jae    80104ad8 <fetchstr+0x48>
80104ab4:	89 d8                	mov    %ebx,%eax
80104ab6:	eb 0f                	jmp    80104ac7 <fetchstr+0x37>
...
80104b01:	8b 40 20             	mov    0x20(%eax),%eax
80104b04:	8b 40 44             	mov    0x44(%eax),%eax
80104b07:	8d 1c 90             	lea    (%eax,%edx,4),%ebx
  struct proc *curproc = myproc();
80104b0a:	e8 71 ee ff ff       	call   80103980 <myproc>
  return fetchint((myproc()->tf->esp) + 4 + 4*n, ip);
80104b0f:	8d 73 04             	lea    0x4(%ebx),%esi
  if(addr >= curproc->sz || addr+4 > curproc->sz)
80104b12:	8b 40 08             	mov    0x8(%eax),%eax
80104b15:	39 c6                	cmp    %eax,%esi
80104b17:	73 17                	jae    80104b30 <argint+0x40>
80104b19:	8d 53 08             	lea    0x8(%ebx),%edx
80104b1c:	39 d0                	cmp    %edx,%eax
80104b1e:	72 10                	jb     80104b30 <argint+0x40>
  *ip = *(int*)(addr);
80104b20:	8b 45 0c             	mov    0xc(%ebp),%eax
80104b23:	8b 53 04             	mov    0x4(%ebx),%edx
80104b26:	89 10                	mov    %edx,(%eax)
  return 0;
...
80104b30:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
  return fetchint((myproc()->tf->esp) + 4 + 4*n, ip);
80104b35:	eb f3                	jmp    80104b2a <argint+0x3a>
...
80104b4c:	8b 5d 10             	mov    0x10(%ebp),%ebx
  int i;
  struct proc *curproc = myproc();
80104b4f:	e8 2c ee ff ff       	call   80103980 <myproc>
...
80104b70:	8b 56 08             	mov    0x8(%esi),%edx
80104b73:	8b 45 f4             	mov    -0xc(%ebp),%eax
80104b76:	39 c2                	cmp    %eax,%edx
80104b78:	76 16                	jbe    80104b90 <argptr+0x50>
80104b7a:	01 c3                	add    %eax,%ebx
80104b7c:	39 da                	cmp    %ebx,%edx
80104b7e:	72 10                	jb     80104b90 <argptr+0x50>
    return -1;
  *pp = (char*)i;
80104b80:	8b 55 0c             	mov    0xc(%ebp),%edx
80104b83:	89 02                	mov    %eax,(%edx)
  return 0;
...
80104b95:	eb f0                	jmp    80104b87 <argptr+0x47>
...
80104c20:	50                   	push   %eax
            curproc->pid, curproc->name, num);
80104c21:	8d 43 74             	lea    0x74(%ebx),%eax
    cprintf("%d %s: unknown sys call %d\n",
80104c24:	50                   	push   %eax
80104c25:	ff 73 18             	pushl  0x18(%ebx)
80104c28:	68 fd 79 10 80       	push   $0x801079fd
80104c2d:	e8 7e ba ff ff       	call   801006b0 <cprintf>
    curproc->tf->eax = -1;
80104c32:	8b 43 20             	mov    0x20(%ebx),%eax
...
80104d84:	68 b0 7a 10 80       	push   $0x80107ab0
...
80104d9c:	68 af 7a 10 80       	push   $0x80107aaf
...
80104db1:	68 a3 7a 10 80       	push   $0x80107aa3
...
80104dcf:	68 b2 7a 10 80       	push   $0x80107ab2
80104dd4:	e8 b7 b5 ff ff       	call   80100390 <panic>
    panic("create: ialloc");
80104dd9:	83 ec 0c             	sub    $0xc,%esp
80104ddc:	68 94 7a 10 80       	push   $0x80107a94
...
80104e14:	e8 67 eb ff ff       	call   80103980 <myproc>
80104e19:	8b 55 f4             	mov    -0xc(%ebp),%edx
80104e1c:	8b 44 90 30          	mov    0x30(%eax,%edx,4),%eax
...
80104e5d:	31 db                	xor    %ebx,%ebx
  struct proc *curproc = myproc();
80104e5f:	e8 1c eb ff ff       	call   80103980 <myproc>
  for(fd = 0; fd < NOFILE; fd++){
80104e64:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
    if(curproc->ofile[fd] == 0){
80104e68:	8b 54 98 30          	mov    0x30(%eax,%ebx,4),%edx
...
80104e8d:	8d 76 00             	lea    0x0(%esi),%esi
      curproc->ofile[fd] = f;
80104e90:	89 74 98 30          	mov    %esi,0x30(%eax,%ebx,4)
  filedup(f);
...
80104fa7:	78 27                	js     80104fd0 <sys_close+0x40>
  myproc()->ofile[fd] = 0;
80104fa9:	e8 d2 e9 ff ff       	call   80103980 <myproc>
80104fae:	8b 55 f0             	mov    -0x10(%ebp),%edx
  fileclose(f);
80104fb1:	83 ec 0c             	sub    $0xc,%esp
  myproc()->ofile[fd] = 0;
80104fb4:	c7 44 90 30 00 00 00 	movl   $0x0,0x30(%eax,%edx,4)
80104fbb:	00 
  fileclose(f);
...
801051cd:	58                   	pop    %eax
801051ce:	5a                   	pop    %edx
801051cf:	68 b0 7a 10 80       	push   $0x80107ab0
...
801051e8:	68 af 7a 10 80       	push   $0x80107aaf
...
801053de:	31 db                	xor    %ebx,%ebx
    if(curproc->ofile[fd] == 0){
801053e0:	8b 54 98 30          	mov    0x30(%eax,%ebx,4),%edx
...
80105448:	83 ec 0c             	sub    $0xc,%esp
      curproc->ofile[fd] = f;
8010544b:	89 7c 98 30          	mov    %edi,0x30(%eax,%ebx,4)
  iunlock(ip);
...
801055b9:	83 ec 10             	sub    $0x10,%esp
  ...
  struct inode *ip;
  struct proc *curproc = myproc();
801055bc:	e8 bf e3 ff ff       	call   80103980 <myproc>
...
8010579b:	31 db                	xor    %ebx,%ebx
  struct proc *curproc = myproc();
8010579d:	e8 de e1 ff ff       	call   80103980 <myproc>
  for(fd = 0; fd < NOFILE; fd++){
801057a2:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
    if(curproc->ofile[fd] == 0){
801057a8:	8b 74 98 30          	mov    0x30(%eax,%ebx,4),%esi
...
801057d4:	eb 4b                	jmp    80105821 <sys_pipe+0xc1>
801057d6:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
801057dd:	8d 76 00             	lea    0x0(%esi),%esi
      curproc->ofile[fd] = f;
801057e0:	8d 73 0c             	lea    0xc(%ebx),%esi
801057e3:	89 3c b0             	mov    %edi,(%eax,%esi,4)
  if((fd0 = fdalloc(rf)) < 0 || (fd1 = fdalloc(wf)) < 0){
801057e6:	8b 7d e4             	mov    -0x1c(%ebp),%edi
  struct proc *curproc = myproc();
801057e9:	e8 92 e1 ff ff       	call   80103980 <myproc>
  for(fd = 0; fd < NOFILE; fd++){
801057ee:	31 d2                	xor    %edx,%edx
    if(curproc->ofile[fd] == 0){
801057f0:	8b 4c 90 30          	mov    0x30(%eax,%edx,4),%ecx
...
80105805:	c7 04 b0 00 00 00 00 	movl   $0x0,(%eax,%esi,4)
8010580c:	eb aa                	jmp    801057b8 <sys_pipe+0x58>
8010580e:	66 90                	xchg   %ax,%ax
      curproc->ofile[fd] = f;
80105810:	89 7c 90 30          	mov    %edi,0x30(%eax,%edx,4)
  }
  fd[0] = fd0;
...
80105830:	f3 0f 1e fb          	endbr32 
  return fork();
80105834:	e9 f7 e2 ff ff       	jmp    80103b30 <fork>
...
80105860:	f3 0f 1e fb          	endbr32 
  return wait();
80105864:	e9 a7 e7 ff ff       	jmp    80104010 <wait>
...
80105880:	e8 6b f2 ff ff       	call   80104af0 <argint>
...
80105892:	e8 e9 e8 ff ff       	call   80104180 <kill>
...
801058b7:	83 ec 08             	sub    $0x8,%esp
  return myproc()->pid;
801058ba:	e8 c1 e0 ff ff       	call   80103980 <myproc>
...
801058e1:	e8 0a f2 ff ff       	call   80104af0 <argint>
...
801058f2:	83 ec 0c             	sub    $0xc,%esp
  addr = myproc()->sz;
801058f5:	8b 58 08             	mov    0x8(%eax),%ebx
  if(growproc(n) < 0)
801058f8:	ff 75 f4             	pushl  -0xc(%ebp)
801058fb:	e8 b0 e1 ff ff       	call   80103ab0 <growproc>
80105900:	83 c4 10             	add    $0x10,%esp
80105903:	85 c0                	test   %eax,%eax
80105905:	78 09                	js     80105910 <sys_sbrk+0x40>
    return -1;
  return addr;
}
...
80105931:	e8 ba f1 ff ff       	call   80104af0 <argint>
...
80105944:	68 60 4e 11 80       	push   $0x80114e60
80105949:	e8 b2 ed ff ff       	call   80104700 <acquire>
  ticks0 = ticks;
...
80105968:	68 a0 56 11 80       	push   $0x801156a0
8010596d:	e8 de e5 ff ff       	call   80103f50 <sleep>
  while(ticks - ticks0 < n){
80105972:	a1 a0 56 11 80       	mov    0x801156a0,%eax
...
8010597f:	73 2f                	jae    801059b0 <sys_sleep+0x90>
    if(myproc()->killed){
80105981:	e8 fa df ff ff       	call   80103980 <myproc>
80105986:	8b 40 2c             	mov    0x2c(%eax),%eax
80105989:	85 c0                	test   %eax,%eax
8010598b:	74 d3                	je     80105960 <sys_sleep+0x40>
      release(&tickslock);
8010598d:	83 ec 0c             	sub    $0xc,%esp
80105990:	68 60 4e 11 80       	push   $0x80114e60
...
801059d8:	83 ec 10             	sub    $0x10,%esp
  ...
  acquire(&tickslock);
801059db:	68 60 4e 11 80       	push   $0x80114e60
801059e0:	e8 1b ed ff ff       	call   80104700 <acquire>
  xticks = ticks;
801059e5:	8b 1d a0 56 11 80    	mov    0x801156a0,%ebx
  release(&tickslock);
801059eb:	c7 04 24 60 4e 11 80 	movl   $0x80114e60,(%esp)
801059f2:	e8 c9 ed ff ff       	call   801047c0 <release>
  return xticks;
}
...
80105a07:	83 ec 14             	sub    $0x14,%esp
  cprintf("hello\n");
80105a0a:	68 f5 7a 10 80       	push   $0x80107af5
80105a0f:	e8 9c ac ff ff       	call   801006b0 <cprintf>
  return 0;
}
...
80105a30:	e8 6b f1 ff ff       	call   80104ba0 <argstr>

  cprintf("hello %s\n", name);
80105a35:	58                   	pop    %eax
80105a36:	5a                   	pop    %edx
80105a37:	ff 75 f4             	pushl  -0xc(%ebp)
80105a3a:	68 fc 7a 10 80       	push   $0x80107afc
80105a3f:	e8 6c ac ff ff       	call   801006b0 <cprintf>
  return 0;
}
...
80105a50:	f3 0f 1e fb          	endbr32 
  return getNumProc();
80105a54:	e9 97 e8 ff ff       	jmp    801042f0 <getNumProc>
80105a59:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi

80105a60 <sys_getMaxPid>:
}
...
80105a60:	f3 0f 1e fb          	endbr32 
  return getMaxPid();
80105a64:	e9 d7 e8 ff ff       	jmp    80104340 <getMaxPid>
80105a69:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi

80105a70 <sys_getProcInfo>:
}
...
80105a80:	e8 6b f0 ff ff       	call   80104af0 <argint>
...
80105a90:	e8 ab f0 ff ff       	call   80104b40 <argptr>
80105a95:	83 c4 10             	add    $0x10,%esp
80105a98:	85 c0                	test   %eax,%eax
80105a9a:	78 14                	js     80105ab0 <sys_getProcInfo+0x40>
    return -1;
  }
...
80105aa2:	ff 75 f0             	pushl  -0x10(%ebp)
80105aa5:	e8 e6 e8 ff ff       	call   80104390 <getProcInfo>
...
80105ad0:	e8 1b f0 ff ff       	call   80104af0 <argint>
...
80105af4:	06                   	push   %es
  pushl %fs
80105af5:	0f a0                	push   %fs
  pushl %gs
80105af7:	0f a8                	push   %gs
  pushal
80105af9:	60                   	pusha  
  
  # Set up data segments.
  movw $(SEG_KDATA<<3), %ax
80105afa:	66 b8 10 00          	mov    $0x10,%ax
  movw %ax, %ds
80105afe:	8e d8                	mov    %eax,%ds
  movw %ax, %es
80105b00:	8e c0                	mov    %eax,%es

  # Call trap(tf), where tf=%esp
  pushl %esp
80105b02:	54                   	push   %esp
  call trap
80105b03:	e8 c8 00 00 00       	call   80105bd0 <trap>
  addl $4, %esp
80105b08:	83 c4 04             	add    $0x4,%esp
...
80105b0b:	61                   	popa   
  popl %gs
80105b0c:	0f a9                	pop    %gs
  popl %fs
80105b0e:	0f a1                	pop    %fs
  popl %es
80105b10:	07                   	pop    %es
  popl %ds
80105b11:	1f                   	pop    %ds
  addl $0x8, %esp  # trapno and errcode
80105b12:	83 c4 08             	add    $0x8,%esp
  iret
80105b15:	cf                   	iret   
...
80105b37:	c7 04 c5 a2 4e 11 80 	movl   $0x8e000008,-0x7feeb15e(,%eax,8)
80105b3e:	08 00 00 8e 
80105b42:	66 89 14 c5 a0 4e 11 	mov    %dx,-0x7feeb160(,%eax,8)
80105b49:	80 
80105b4a:	c1 ea 10             	shr    $0x10,%edx
80105b4d:	66 89 14 c5 a6 4e 11 	mov    %dx,-0x7feeb15a(,%eax,8)
80105b54:	80 
  for(i = 0; i < 256; i++)
...
80105b67:	c7 05 a2 50 11 80 08 	movl   $0xef000008,0x801150a2
80105b6e:	00 00 ef 
  initlock(&tickslock, "time");
80105b71:	68 06 7b 10 80       	push   $0x80107b06
80105b76:	68 60 4e 11 80       	push   $0x80114e60
  SETGATE(idt[T_SYSCALL], 1, SEG_KCODE<<3, vectors[T_SYSCALL], DPL_USER);
80105b7b:	66 a3 a0 50 11 80    	mov    %ax,0x801150a0
80105b81:	c1 e8 10             	shr    $0x10,%eax
80105b84:	66 a3 a6 50 11 80    	mov    %ax,0x801150a6
  initlock(&tickslock, "time");
80105b8a:	e8 f1 e9 ff ff       	call   80104580 <initlock>
}
...
80105baf:	66 89 45 fa          	mov    %ax,-0x6(%ebp)
  pd[1] = (uint)p;
80105bb3:	b8 a0 4e 11 80       	mov    $0x80114ea0,%eax
...
80105be6:	0f 84 bc 01 00 00    	je     80105da8 <trap+0x1d8>
    if(myproc()->killed)
      exit();
    return;
  }
  ...
  switch(tf->trapno){
80105bec:	83 e8 20             	sub    $0x20,%eax
80105bef:	83 f8 1f             	cmp    $0x1f,%eax
80105bf2:	77 08                	ja     80105bfc <trap+0x2c>
80105bf4:	3e ff 24 85 ac 7b 10 	notrack jmp *-0x7fef8454(,%eax,4)
80105bfb:	80 
    lapiceoi();
    break;
...
80105bfc:	e8 7f dd ff ff       	call   80103980 <myproc>
80105c01:	8b 7b 38             	mov    0x38(%ebx),%edi
80105c04:	85 c0                	test   %eax,%eax
80105c06:	0f 84 eb 01 00 00    	je     80105df7 <trap+0x227>
80105c0c:	f6 43 3c 03          	testb  $0x3,0x3c(%ebx)
80105c10:	0f 84 e1 01 00 00    	je     80105df7 <trap+0x227>
...
80105c1c:	e8 3f dd ff ff       	call   80103960 <cpuid>
...
80105c2d:	e8 4e dd ff ff       	call   80103980 <myproc>
80105c32:	89 45 e0             	mov    %eax,-0x20(%ebp)
80105c35:	e8 46 dd ff ff       	call   80103980 <myproc>
    cprintf("pid %d %s: trap %d err %d on cpu %d "
...
80105c43:	ff 75 e4             	pushl  -0x1c(%ebp)
80105c46:	56                   	push   %esi
            myproc()->pid, myproc()->name, tf->trapno,
80105c47:	8b 75 e0             	mov    -0x20(%ebp),%esi
80105c4a:	83 c6 74             	add    $0x74,%esi
    cprintf("pid %d %s: trap %d err %d on cpu %d "
80105c4d:	56                   	push   %esi
80105c4e:	ff 70 18             	pushl  0x18(%eax)
80105c51:	68 68 7b 10 80       	push   $0x80107b68
80105c56:	e8 55 aa ff ff       	call   801006b0 <cprintf>
            tf->err, cpuid(), tf->eip, rcr2());
    myproc()->killed = 1;
80105c5b:	83 c4 20             	add    $0x20,%esp
80105c5e:	e8 1d dd ff ff       	call   80103980 <myproc>
80105c63:	c7 40 2c 01 00 00 00 	movl   $0x1,0x2c(%eax)
  }
...
80105c71:	74 1d                	je     80105c90 <trap+0xc0>
80105c73:	e8 08 dd ff ff       	call   80103980 <myproc>
80105c78:	8b 50 2c             	mov    0x2c(%eax),%edx
80105c7b:	85 d2                	test   %edx,%edx
80105c7d:	74 11                	je     80105c90 <trap+0xc0>
80105c7f:	0f b7 43 3c          	movzwl 0x3c(%ebx),%eax
80105c83:	83 e0 03             	and    $0x3,%eax
80105c86:	66 83 f8 03          	cmp    $0x3,%ax
80105c8a:	0f 84 50 01 00 00    	je     80105de0 <trap+0x210>
    exit();
...
80105c97:	74 0f                	je     80105ca8 <trap+0xd8>
80105c99:	e8 e2 dc ff ff       	call   80103980 <myproc>
80105c9e:	83 78 14 04          	cmpl   $0x4,0x14(%eax)
80105ca2:	0f 84 e8 00 00 00    	je     80105d90 <trap+0x1c0>
...
80105caf:	74 1d                	je     80105cce <trap+0xfe>
80105cb1:	e8 ca dc ff ff       	call   80103980 <myproc>
80105cb6:	8b 40 2c             	mov    0x2c(%eax),%eax
80105cb9:	85 c0                	test   %eax,%eax
80105cbb:	74 11                	je     80105cce <trap+0xfe>
80105cbd:	0f b7 43 3c          	movzwl 0x3c(%ebx),%eax
80105cc1:	83 e0 03             	and    $0x3,%eax
80105cc4:	66 83 f8 03          	cmp    $0x3,%ax
80105cc8:	0f 84 03 01 00 00    	je     80105dd1 <trap+0x201>
    exit();
}
...
80105cd5:	c3                   	ret    
    ideintr();
80105cd6:	e8 05 c5 ff ff       	call   801021e0 <ideintr>
    lapiceoi();
80105cdb:	e8 e0 cb ff ff       	call   801028c0 <lapiceoi>
  if(myproc() && myproc()->killed && (tf->cs&3) == DPL_USER)
80105ce0:	e8 9b dc ff ff       	call   80103980 <myproc>
80105ce5:	85 c0                	test   %eax,%eax
80105ce7:	75 8a                	jne    80105c73 <trap+0xa3>
80105ce9:	eb a5                	jmp    80105c90 <trap+0xc0>
    if(cpuid() == 0){
80105ceb:	e8 70 dc ff ff       	call   80103960 <cpuid>
80105cf0:	85 c0                	test   %eax,%eax
80105cf2:	75 e7                	jne    80105cdb <trap+0x10b>
      acquire(&tickslock);
80105cf4:	83 ec 0c             	sub    $0xc,%esp
80105cf7:	68 60 4e 11 80       	push   $0x80114e60
80105cfc:	e8 ff e9 ff ff       	call   80104700 <acquire>
      wakeup(&ticks);
80105d01:	c7 04 24 a0 56 11 80 	movl   $0x801156a0,(%esp)
      ticks++;
80105d08:	83 05 a0 56 11 80 01 	addl   $0x1,0x801156a0
      wakeup(&ticks);
80105d0f:	e8 fc e3 ff ff       	call   80104110 <wakeup>
      release(&tickslock);
80105d14:	c7 04 24 60 4e 11 80 	movl   $0x80114e60,(%esp)
80105d1b:	e8 a0 ea ff ff       	call   801047c0 <release>
80105d20:	83 c4 10             	add    $0x10,%esp
    lapiceoi();
80105d23:	eb b6                	jmp    80105cdb <trap+0x10b>
    kbdintr();
80105d25:	e8 56 ca ff ff       	call   80102780 <kbdintr>
    lapiceoi();
80105d2a:	e8 91 cb ff ff       	call   801028c0 <lapiceoi>
  if(myproc() && myproc()->killed && (tf->cs&3) == DPL_USER)
80105d2f:	e8 4c dc ff ff       	call   80103980 <myproc>
80105d34:	85 c0                	test   %eax,%eax
80105d36:	0f 85 37 ff ff ff    	jne    80105c73 <trap+0xa3>
80105d3c:	e9 4f ff ff ff       	jmp    80105c90 <trap+0xc0>
    uartintr();
80105d41:	e8 4a 02 00 00       	call   80105f90 <uartintr>
    lapiceoi();
80105d46:	e8 75 cb ff ff       	call   801028c0 <lapiceoi>
  if(myproc() && myproc()->killed && (tf->cs&3) == DPL_USER)
80105d4b:	e8 30 dc ff ff       	call   80103980 <myproc>
80105d50:	85 c0                	test   %eax,%eax
80105d52:	0f 85 1b ff ff ff    	jne    80105c73 <trap+0xa3>
80105d58:	e9 33 ff ff ff       	jmp    80105c90 <trap+0xc0>
    cprintf("cpu%d: spurious interrupt at %x:%x\n",
80105d5d:	8b 7b 38             	mov    0x38(%ebx),%edi
80105d60:	0f b7 73 3c          	movzwl 0x3c(%ebx),%esi
80105d64:	e8 f7 db ff ff       	call   80103960 <cpuid>
80105d69:	57                   	push   %edi
80105d6a:	56                   	push   %esi
80105d6b:	50                   	push   %eax
80105d6c:	68 10 7b 10 80       	push   $0x80107b10
80105d71:	e8 3a a9 ff ff       	call   801006b0 <cprintf>
    lapiceoi();
80105d76:	e8 45 cb ff ff       	call   801028c0 <lapiceoi>
    break;
80105d7b:	83 c4 10             	add    $0x10,%esp
  if(myproc() && myproc()->killed && (tf->cs&3) == DPL_USER)
80105d7e:	e8 fd db ff ff       	call   80103980 <myproc>
80105d83:	85 c0                	test   %eax,%eax
80105d85:	0f 85 e8 fe ff ff    	jne    80105c73 <trap+0xa3>
80105d8b:	e9 00 ff ff ff       	jmp    80105c90 <trap+0xc0>
  if(myproc() && myproc()->state == RUNNING &&
80105d90:	83 7b 30 20          	cmpl   $0x20,0x30(%ebx)
80105d94:	0f 85 0e ff ff ff    	jne    80105ca8 <trap+0xd8>
    yield();
80105d9a:	e8 61 e1 ff ff       	call   80103f00 <yield>
80105d9f:	e9 04 ff ff ff       	jmp    80105ca8 <trap+0xd8>
80105da4:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
    if(myproc()->killed)
80105da8:	e8 d3 db ff ff       	call   80103980 <myproc>
80105dad:	8b 70 2c             	mov    0x2c(%eax),%esi
80105db0:	85 f6                	test   %esi,%esi
80105db2:	75 3c                	jne    80105df0 <trap+0x220>
    myproc()->tf = tf;
80105db4:	e8 c7 db ff ff       	call   80103980 <myproc>
80105db9:	89 58 20             	mov    %ebx,0x20(%eax)
    syscall();
80105dbc:	e8 1f ee ff ff       	call   80104be0 <syscall>
    if(myproc()->killed)
80105dc1:	e8 ba db ff ff       	call   80103980 <myproc>
80105dc6:	8b 48 2c             	mov    0x2c(%eax),%ecx
80105dc9:	85 c9                	test   %ecx,%ecx
80105dcb:	0f 84 fd fe ff ff    	je     80105cce <trap+0xfe>
}
...
80105dd7:	5d                   	pop    %ebp
      exit();
80105dd8:	e9 e3 df ff ff       	jmp    80103dc0 <exit>
80105ddd:	8d 76 00             	lea    0x0(%esi),%esi
    exit();
80105de0:	e8 db df ff ff       	call   80103dc0 <exit>
80105de5:	e9 a6 fe ff ff       	jmp    80105c90 <trap+0xc0>
80105dea:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
      exit();
80105df0:	e8 cb df ff ff       	call   80103dc0 <exit>
80105df5:	eb bd                	jmp    80105db4 <trap+0x1e4>
80105df7:	0f 20 d6             	mov    %cr2,%esi
      cprintf("unexpected trap %d from cpu %d eip %x (cr2=0x%x)\n",
80105dfa:	e8 61 db ff ff       	call   80103960 <cpuid>
80105dff:	83 ec 0c             	sub    $0xc,%esp
80105e02:	56                   	push   %esi
80105e03:	57                   	push   %edi
80105e04:	50                   	push   %eax
80105e05:	ff 73 30             	pushl  0x30(%ebx)
80105e08:	68 34 7b 10 80       	push   $0x80107b34
80105e0d:	e8 9e a8 ff ff       	call   801006b0 <cprintf>
      panic("trap");
80105e12:	83 c4 14             	add    $0x14,%esp
80105e15:	68 0b 7b 10 80       	push   $0x80107b0b
80105e1a:	e8 71 a5 ff ff       	call   80100390 <panic>
80105e1f:	90                   	nop
...
80105f13:	be 76 00 00 00       	mov    $0x76,%esi
  for(p="xv6...\n"; *p; p++)
80105f18:	bb 2c 7c 10 80       	mov    $0x80107c2c,%ebx
  ioapicenable(IRQ_COM1, 0);
...
80105fab:	6a 00                	push   $0x0
  jmp alltraps
80105fad:	e9 41 fb ff ff       	jmp    80105af3 <alltraps>
...
80105fb4:	6a 01                	push   $0x1
  jmp alltraps
80105fb6:	e9 38 fb ff ff       	jmp    80105af3 <alltraps>
...
80105fbd:	6a 02                	push   $0x2
  jmp alltraps
80105fbf:	e9 2f fb ff ff       	jmp    80105af3 <alltraps>
...
80105fc6:	6a 03                	push   $0x3
  jmp alltraps
80105fc8:	e9 26 fb ff ff       	jmp    80105af3 <alltraps>
...
80105fcf:	6a 04                	push   $0x4
  jmp alltraps
80105fd1:	e9 1d fb ff ff       	jmp    80105af3 <alltraps>
...
80105fd8:	6a 05                	push   $0x5
  jmp alltraps
80105fda:	e9 14 fb ff ff       	jmp    80105af3 <alltraps>
...
80105fe1:	6a 06                	push   $0x6
  jmp alltraps
80105fe3:	e9 0b fb ff ff       	jmp    80105af3 <alltraps>
...
80105fea:	6a 07                	push   $0x7
  jmp alltraps
80105fec:	e9 02 fb ff ff       	jmp    80105af3 <alltraps>
...
80105ff1:	6a 08                	push   $0x8
  jmp alltraps
80105ff3:	e9 fb fa ff ff       	jmp    80105af3 <alltraps>
...
80105ffa:	6a 09                	push   $0x9
  jmp alltraps
80105ffc:	e9 f2 fa ff ff       	jmp    80105af3 <alltraps>
...
80106001:	6a 0a                	push   $0xa
  jmp alltraps
80106003:	e9 eb fa ff ff       	jmp    80105af3 <alltraps>
...
80106008:	6a 0b                	push   $0xb
  jmp alltraps
8010600a:	e9 e4 fa ff ff       	jmp    80105af3 <alltraps>
...
8010600f:	6a 0c                	push   $0xc
  jmp alltraps
80106011:	e9 dd fa ff ff       	jmp    80105af3 <alltraps>
...
80106016:	6a 0d                	push   $0xd
  jmp alltraps
80106018:	e9 d6 fa ff ff       	jmp    80105af3 <alltraps>
...
8010601d:	6a 0e                	push   $0xe
  jmp alltraps
8010601f:	e9 cf fa ff ff       	jmp    80105af3 <alltraps>
...
80106026:	6a 0f                	push   $0xf
  jmp alltraps
80106028:	e9 c6 fa ff ff       	jmp    80105af3 <alltraps>
...
8010602f:	6a 10                	push   $0x10
  jmp alltraps
80106031:	e9 bd fa ff ff       	jmp    80105af3 <alltraps>
...
80106036:	6a 11                	push   $0x11
  jmp alltraps
80106038:	e9 b6 fa ff ff       	jmp    80105af3 <alltraps>
...
8010603f:	6a 12                	push   $0x12
  jmp alltraps
80106041:	e9 ad fa ff ff       	jmp    80105af3 <alltraps>
...
80106048:	6a 13                	push   $0x13
  jmp alltraps
8010604a:	e9 a4 fa ff ff       	jmp    80105af3 <alltraps>
...
80106051:	6a 14                	push   $0x14
  jmp alltraps
80106053:	e9 9b fa ff ff       	jmp    80105af3 <alltraps>
...
8010605a:	6a 15                	push   $0x15
  jmp alltraps
8010605c:	e9 92 fa ff ff       	jmp    80105af3 <alltraps>
...
80106063:	6a 16                	push   $0x16
  jmp alltraps
80106065:	e9 89 fa ff ff       	jmp    80105af3 <alltraps>
...
8010606c:	6a 17                	push   $0x17
  jmp alltraps
8010606e:	e9 80 fa ff ff       	jmp    80105af3 <alltraps>
...
80106075:	6a 18                	push   $0x18
  jmp alltraps
80106077:	e9 77 fa ff ff       	jmp    80105af3 <alltraps>
...
8010607e:	6a 19                	push   $0x19
  jmp alltraps
80106080:	e9 6e fa ff ff       	jmp    80105af3 <alltraps>
...
80106087:	6a 1a                	push   $0x1a
  jmp alltraps
80106089:	e9 65 fa ff ff       	jmp    80105af3 <alltraps>
...
80106090:	6a 1b                	push   $0x1b
  jmp alltraps
80106092:	e9 5c fa ff ff       	jmp    80105af3 <alltraps>
...
80106099:	6a 1c                	push   $0x1c
  jmp alltraps
8010609b:	e9 53 fa ff ff       	jmp    80105af3 <alltraps>
...
801060a2:	6a 1d                	push   $0x1d
  jmp alltraps
801060a4:	e9 4a fa ff ff       	jmp    80105af3 <alltraps>
...
801060ab:	6a 1e                	push   $0x1e
  jmp alltraps
801060ad:	e9 41 fa ff ff       	jmp    80105af3 <alltraps>
...
801060b4:	6a 1f                	push   $0x1f
  jmp alltraps
801060b6:	e9 38 fa ff ff       	jmp    80105af3 <alltraps>
...
801060bd:	6a 20                	push   $0x20
  jmp alltraps
801060bf:	e9 2f fa ff ff       	jmp    80105af3 <alltraps>
...
801060c6:	6a 21                	push   $0x21
  jmp alltraps
801060c8:	e9 26 fa ff ff       	jmp    80105af3 <alltraps>
...
801060cf:	6a 22                	push   $0x22
  jmp alltraps
801060d1:	e9 1d fa ff ff       	jmp    80105af3 <alltraps>
...
801060d8:	6a 23                	push   $0x23
  jmp alltraps
801060da:	e9 14 fa ff ff       	jmp    80105af3 <alltraps>
...
801060e1:	6a 24                	push   $0x24
  jmp alltraps
801060e3:	e9 0b fa ff ff       	jmp    80105af3 <alltraps>
...
801060ea:	6a 25                	push   $0x25
  jmp alltraps
801060ec:	e9 02 fa ff ff       	jmp    80105af3 <alltraps>
...
801060f3:	6a 26                	push   $0x26
  jmp alltraps
801060f5:	e9 f9 f9 ff ff       	jmp    80105af3 <alltraps>
...
801060fc:	6a 27                	push   $0x27
  jmp alltraps
801060fe:	e9 f0 f9 ff ff       	jmp    80105af3 <alltraps>
...
80106105:	6a 28                	push   $0x28
  jmp alltraps
80106107:	e9 e7 f9 ff ff       	jmp    80105af3 <alltraps>
...
8010610e:	6a 29                	push   $0x29
  jmp alltraps
80106110:	e9 de f9 ff ff       	jmp    80105af3 <alltraps>
...
80106117:	6a 2a                	push   $0x2a
  jmp alltraps
80106119:	e9 d5 f9 ff ff       	jmp    80105af3 <alltraps>
...
80106120:	6a 2b                	push   $0x2b
  jmp alltraps
80106122:	e9 cc f9 ff ff       	jmp    80105af3 <alltraps>
...
80106129:	6a 2c                	push   $0x2c
  jmp alltraps
8010612b:	e9 c3 f9 ff ff       	jmp    80105af3 <alltraps>
...
80106132:	6a 2d                	push   $0x2d
  jmp alltraps
80106134:	e9 ba f9 ff ff       	jmp    80105af3 <alltraps>
...
8010613b:	6a 2e                	push   $0x2e
  jmp alltraps
8010613d:	e9 b1 f9 ff ff       	jmp    80105af3 <alltraps>
...
80106144:	6a 2f                	push   $0x2f
  jmp alltraps
80106146:	e9 a8 f9 ff ff       	jmp    80105af3 <alltraps>
...
8010614d:	6a 30                	push   $0x30
  jmp alltraps
8010614f:	e9 9f f9 ff ff       	jmp    80105af3 <alltraps>
...
80106156:	6a 31                	push   $0x31
  jmp alltraps
80106158:	e9 96 f9 ff ff       	jmp    80105af3 <alltraps>
...
8010615f:	6a 32                	push   $0x32
  jmp alltraps
80106161:	e9 8d f9 ff ff       	jmp    80105af3 <alltraps>
...
80106168:	6a 33                	push   $0x33
  jmp alltraps
8010616a:	e9 84 f9 ff ff       	jmp    80105af3 <alltraps>
...
80106171:	6a 34                	push   $0x34
  jmp alltraps
80106173:	e9 7b f9 ff ff       	jmp    80105af3 <alltraps>
...
8010617a:	6a 35                	push   $0x35
  jmp alltraps
8010617c:	e9 72 f9 ff ff       	jmp    80105af3 <alltraps>
...
80106183:	6a 36                	push   $0x36
  jmp alltraps
80106185:	e9 69 f9 ff ff       	jmp    80105af3 <alltraps>
...
8010618c:	6a 37                	push   $0x37
  jmp alltraps
8010618e:	e9 60 f9 ff ff       	jmp    80105af3 <alltraps>
...
80106195:	6a 38                	push   $0x38
  jmp alltraps
80106197:	e9 57 f9 ff ff       	jmp    80105af3 <alltraps>
...
8010619e:	6a 39                	push   $0x39
  jmp alltraps
801061a0:	e9 4e f9 ff ff       	jmp    80105af3 <alltraps>
...
801061a7:	6a 3a                	push   $0x3a
  jmp alltraps
801061a9:	e9 45 f9 ff ff       	jmp    80105af3 <alltraps>
...
801061b0:	6a 3b                	push   $0x3b
  jmp alltraps
801061b2:	e9 3c f9 ff ff       	jmp    80105af3 <alltraps>
...
801061b9:	6a 3c                	push   $0x3c
  jmp alltraps
801061bb:	e9 33 f9 ff ff       	jmp    80105af3 <alltraps>
...
801061c2:	6a 3d                	push   $0x3d
  jmp alltraps
801061c4:	e9 2a f9 ff ff       	jmp    80105af3 <alltraps>
...
801061cb:	6a 3e                	push   $0x3e
  jmp alltraps
801061cd:	e9 21 f9 ff ff       	jmp    80105af3 <alltraps>
...
801061d4:	6a 3f                	push   $0x3f
  jmp alltraps
801061d6:	e9 18 f9 ff ff       	jmp    80105af3 <alltraps>
...
801061dd:	6a 40                	push   $0x40
  jmp alltraps
801061df:	e9 0f f9 ff ff       	jmp    80105af3 <alltraps>
...
801061e6:	6a 41                	push   $0x41
  jmp alltraps
801061e8:	e9 06 f9 ff ff       	jmp    80105af3 <alltraps>
...
801061ef:	6a 42                	push   $0x42
  jmp alltraps
801061f1:	e9 fd f8 ff ff       	jmp    80105af3 <alltraps>
...
801061f8:	6a 43                	push   $0x43
  jmp alltraps
801061fa:	e9 f4 f8 ff ff       	jmp    80105af3 <alltraps>
...
80106201:	6a 44                	push   $0x44
  jmp alltraps
80106203:	e9 eb f8 ff ff       	jmp    80105af3 <alltraps>
...
8010620a:	6a 45                	push   $0x45
  jmp alltraps
8010620c:	e9 e2 f8 ff ff       	jmp    80105af3 <alltraps>
...
80106213:	6a 46                	push   $0x46
  jmp alltraps
80106215:	e9 d9 f8 ff ff       	jmp    80105af3 <alltraps>
...
8010621c:	6a 47                	push   $0x47
  jmp alltraps
8010621e:	e9 d0 f8 ff ff       	jmp    80105af3 <alltraps>
...
80106225:	6a 48                	push   $0x48
  jmp alltraps
80106227:	e9 c7 f8 ff ff       	jmp    80105af3 <alltraps>
...
8010622e:	6a 49                	push   $0x49
  jmp alltraps
80106230:	e9 be f8 ff ff       	jmp    80105af3 <alltraps>
...
80106237:	6a 4a                	push   $0x4a
  jmp alltraps
80106239:	e9 b5 f8 ff ff       	jmp    80105af3 <alltraps>
...
80106240:	6a 4b                	push   $0x4b
  jmp alltraps
80106242:	e9 ac f8 ff ff       	jmp    80105af3 <alltraps>
...
80106249:	6a 4c                	push   $0x4c
  jmp alltraps
8010624b:	e9 a3 f8 ff ff       	jmp    80105af3 <alltraps>
...
80106252:	6a 4d                	push   $0x4d
  jmp alltraps
80106254:	e9 9a f8 ff ff       	jmp    80105af3 <alltraps>
...
8010625b:	6a 4e                	push   $0x4e
  jmp alltraps
8010625d:	e9 91 f8 ff ff       	jmp    80105af3 <alltraps>
...
80106264:	6a 4f                	push   $0x4f
  jmp alltraps
80106266:	e9 88 f8 ff ff       	jmp    80105af3 <alltraps>
...
8010626d:	6a 50                	push   $0x50
  jmp alltraps
8010626f:	e9 7f f8 ff ff       	jmp    80105af3 <alltraps>
...
80106276:	6a 51                	push   $0x51
  jmp alltraps
80106278:	e9 76 f8 ff ff       	jmp    80105af3 <alltraps>
...
8010627f:	6a 52                	push   $0x52
  jmp alltraps
80106281:	e9 6d f8 ff ff       	jmp    80105af3 <alltraps>
...
80106288:	6a 53                	push   $0x53
  jmp alltraps
8010628a:	e9 64 f8 ff ff       	jmp    80105af3 <alltraps>
...
80106291:	6a 54                	push   $0x54
  jmp alltraps
80106293:	e9 5b f8 ff ff       	jmp    80105af3 <alltraps>
...
8010629a:	6a 55                	push   $0x55
  jmp alltraps
8010629c:	e9 52 f8 ff ff       	jmp    80105af3 <alltraps>
...
801062a3:	6a 56                	push   $0x56
  jmp alltraps
801062a5:	e9 49 f8 ff ff       	jmp    80105af3 <alltraps>
...
801062ac:	6a 57                	push   $0x57
  jmp alltraps
801062ae:	e9 40 f8 ff ff       	jmp    80105af3 <alltraps>
...
801062b5:	6a 58                	push   $0x58
  jmp alltraps
801062b7:	e9 37 f8 ff ff       	jmp    80105af3 <alltraps>
...
801062be:	6a 59                	push   $0x59
  jmp alltraps
801062c0:	e9 2e f8 ff ff       	jmp    80105af3 <alltraps>
...
801062c7:	6a 5a                	push   $0x5a
  jmp alltraps
801062c9:	e9 25 f8 ff ff       	jmp    80105af3 <alltraps>
...
801062d0:	6a 5b                	push   $0x5b
  jmp alltraps
801062d2:	e9 1c f8 ff ff       	jmp    80105af3 <alltraps>
...
801062d9:	6a 5c                	push   $0x5c
  jmp alltraps
801062db:	e9 13 f8 ff ff       	jmp    80105af3 <alltraps>
...
801062e2:	6a 5d                	push   $0x5d
  jmp alltraps
801062e4:	e9 0a f8 ff ff       	jmp    80105af3 <alltraps>
...
801062eb:	6a 5e                	push   $0x5e
  jmp alltraps
801062ed:	e9 01 f8 ff ff       	jmp    80105af3 <alltraps>
...
801062f4:	6a 5f                	push   $0x5f
  jmp alltraps
801062f6:	e9 f8 f7 ff ff       	jmp    80105af3 <alltraps>
...
801062fd:	6a 60                	push   $0x60
  jmp alltraps
801062ff:	e9 ef f7 ff ff       	jmp    80105af3 <alltraps>
...
80106306:	6a 61                	push   $0x61
  jmp alltraps
80106308:	e9 e6 f7 ff ff       	jmp    80105af3 <alltraps>
...
8010630f:	6a 62                	push   $0x62
  jmp alltraps
80106311:	e9 dd f7 ff ff       	jmp    80105af3 <alltraps>
...
80106318:	6a 63                	push   $0x63
  jmp alltraps
8010631a:	e9 d4 f7 ff ff       	jmp    80105af3 <alltraps>
...
80106321:	6a 64                	push   $0x64
  jmp alltraps
80106323:	e9 cb f7 ff ff       	jmp    80105af3 <alltraps>
...
8010632a:	6a 65                	push   $0x65
  jmp alltraps
8010632c:	e9 c2 f7 ff ff       	jmp    80105af3 <alltraps>
...
80106333:	6a 66                	push   $0x66
  jmp alltraps
80106335:	e9 b9 f7 ff ff       	jmp    80105af3 <alltraps>
...
8010633c:	6a 67                	push   $0x67
  jmp alltraps
8010633e:	e9 b0 f7 ff ff       	jmp    80105af3 <alltraps>
...
80106345:	6a 68                	push   $0x68
  jmp alltraps
80106347:	e9 a7 f7 ff ff       	jmp    80105af3 <alltraps>
...
8010634e:	6a 69                	push   $0x69
  jmp alltraps
80106350:	e9 9e f7 ff ff       	jmp    80105af3 <alltraps>
...
80106357:	6a 6a                	push   $0x6a
  jmp alltraps
80106359:	e9 95 f7 ff ff       	jmp    80105af3 <alltraps>
...
80106360:	6a 6b                	push   $0x6b
  jmp alltraps
80106362:	e9 8c f7 ff ff       	jmp    80105af3 <alltraps>
...
80106369:	6a 6c                	push   $0x6c
  jmp alltraps
8010636b:	e9 83 f7 ff ff       	jmp    80105af3 <alltraps>
...
80106372:	6a 6d                	push   $0x6d
  jmp alltraps
80106374:	e9 7a f7 ff ff       	jmp    80105af3 <alltraps>
...
8010637b:	6a 6e                	push   $0x6e
  jmp alltraps
8010637d:	e9 71 f7 ff ff       	jmp    80105af3 <alltraps>
...
80106384:	6a 6f                	push   $0x6f
  jmp alltraps
80106386:	e9 68 f7 ff ff       	jmp    80105af3 <alltraps>
...
8010638d:	6a 70                	push   $0x70
  jmp alltraps
8010638f:	e9 5f f7 ff ff       	jmp    80105af3 <alltraps>
...
80106396:	6a 71                	push   $0x71
  jmp alltraps
80106398:	e9 56 f7 ff ff       	jmp    80105af3 <alltraps>
...
8010639f:	6a 72                	push   $0x72
  jmp alltraps
801063a1:	e9 4d f7 ff ff       	jmp    80105af3 <alltraps>
...
801063a8:	6a 73                	push   $0x73
  jmp alltraps
801063aa:	e9 44 f7 ff ff       	jmp    80105af3 <alltraps>
...
801063b1:	6a 74                	push   $0x74
  jmp alltraps
801063b3:	e9 3b f7 ff ff       	jmp    80105af3 <alltraps>
...
801063ba:	6a 75                	push   $0x75
  jmp alltraps
801063bc:	e9 32 f7 ff ff       	jmp    80105af3 <alltraps>
...
801063c3:	6a 76                	push   $0x76
  jmp alltraps
801063c5:	e9 29 f7 ff ff       	jmp    80105af3 <alltraps>
...
801063cc:	6a 77                	push   $0x77
  jmp alltraps
801063ce:	e9 20 f7 ff ff       	jmp    80105af3 <alltraps>
...
801063d5:	6a 78                	push   $0x78
  jmp alltraps
801063d7:	e9 17 f7 ff ff       	jmp    80105af3 <alltraps>
...
801063de:	6a 79                	push   $0x79
  jmp alltraps
801063e0:	e9 0e f7 ff ff       	jmp    80105af3 <alltraps>
...
801063e7:	6a 7a                	push   $0x7a
  jmp alltraps
801063e9:	e9 05 f7 ff ff       	jmp    80105af3 <alltraps>
...
801063f0:	6a 7b                	push   $0x7b
  jmp alltraps
801063f2:	e9 fc f6 ff ff       	jmp    80105af3 <alltraps>
...
801063f9:	6a 7c                	push   $0x7c
  jmp alltraps
801063fb:	e9 f3 f6 ff ff       	jmp    80105af3 <alltraps>
...
80106402:	6a 7d                	push   $0x7d
  jmp alltraps
80106404:	e9 ea f6 ff ff       	jmp    80105af3 <alltraps>
...
8010640b:	6a 7e                	push   $0x7e
  jmp alltraps
8010640d:	e9 e1 f6 ff ff       	jmp    80105af3 <alltraps>
...
80106414:	6a 7f                	push   $0x7f
  jmp alltraps
80106416:	e9 d8 f6 ff ff       	jmp    80105af3 <alltraps>
...
8010641d:	68 80 00 00 00       	push   $0x80
  jmp alltraps
80106422:	e9 cc f6 ff ff       	jmp    80105af3 <alltraps>
...
80106429:	68 81 00 00 00       	push   $0x81
  jmp alltraps
8010642e:	e9 c0 f6 ff ff       	jmp    80105af3 <alltraps>
...
80106435:	68 82 00 00 00       	push   $0x82
  jmp alltraps
8010643a:	e9 b4 f6 ff ff       	jmp    80105af3 <alltraps>
...
80106441:	68 83 00 00 00       	push   $0x83
  jmp alltraps
80106446:	e9 a8 f6 ff ff       	jmp    80105af3 <alltraps>
...
8010644d:	68 84 00 00 00       	push   $0x84
  jmp alltraps
80106452:	e9 9c f6 ff ff       	jmp    80105af3 <alltraps>
...
80106459:	68 85 00 00 00       	push   $0x85
  jmp alltraps
8010645e:	e9 90 f6 ff ff       	jmp    80105af3 <alltraps>
...
80106465:	68 86 00 00 00       	push   $0x86
  jmp alltraps
8010646a:	e9 84 f6 ff ff       	jmp    80105af3 <alltraps>
...
80106471:	68 87 00 00 00       	push   $0x87
  jmp alltraps
80106476:	e9 78 f6 ff ff       	jmp    80105af3 <alltraps>
...
8010647d:	68 88 00 00 00       	push   $0x88
  jmp alltraps
80106482:	e9 6c f6 ff ff       	jmp    80105af3 <alltraps>
...
80106489:	68 89 00 00 00       	push   $0x89
  jmp alltraps
8010648e:	e9 60 f6 ff ff       	jmp    80105af3 <alltraps>
...
80106495:	68 8a 00 00 00       	push   $0x8a
  jmp alltraps
8010649a:	e9 54 f6 ff ff       	jmp    80105af3 <alltraps>
...
801064a1:	68 8b 00 00 00       	push   $0x8b
  jmp alltraps
801064a6:	e9 48 f6 ff ff       	jmp    80105af3 <alltraps>
...
801064ad:	68 8c 00 00 00       	push   $0x8c
  jmp alltraps
801064b2:	e9 3c f6 ff ff       	jmp    80105af3 <alltraps>
...
801064b9:	68 8d 00 00 00       	push   $0x8d
  jmp alltraps
801064be:	e9 30 f6 ff ff       	jmp    80105af3 <alltraps>
...
801064c5:	68 8e 00 00 00       	push   $0x8e
  jmp alltraps
801064ca:	e9 24 f6 ff ff       	jmp    80105af3 <alltraps>
...
801064d1:	68 8f 00 00 00       	push   $0x8f
  jmp alltraps
801064d6:	e9 18 f6 ff ff       	jmp    80105af3 <alltraps>
...
801064dd:	68 90 00 00 00       	push   $0x90
  jmp alltraps
801064e2:	e9 0c f6 ff ff       	jmp    80105af3 <alltraps>
...
801064e9:	68 91 00 00 00       	push   $0x91
  jmp alltraps
801064ee:	e9 00 f6 ff ff       	jmp    80105af3 <alltraps>
...
801064f5:	68 92 00 00 00       	push   $0x92
  jmp alltraps
801064fa:	e9 f4 f5 ff ff       	jmp    80105af3 <alltraps>
...
80106501:	68 93 00 00 00       	push   $0x93
  jmp alltraps
80106506:	e9 e8 f5 ff ff       	jmp    80105af3 <alltraps>
...
8010650d:	68 94 00 00 00       	push   $0x94
  jmp alltraps
80106512:	e9 dc f5 ff ff       	jmp    80105af3 <alltraps>
...
80106519:	68 95 00 00 00       	push   $0x95
  jmp alltraps
8010651e:	e9 d0 f5 ff ff       	jmp    80105af3 <alltraps>
...
80106525:	68 96 00 00 00       	push   $0x96
  jmp alltraps
8010652a:	e9 c4 f5 ff ff       	jmp    80105af3 <alltraps>
...
80106531:	68 97 00 00 00       	push   $0x97
  jmp alltraps
80106536:	e9 b8 f5 ff ff       	jmp    80105af3 <alltraps>
...
8010653d:	68 98 00 00 00       	push   $0x98
  jmp alltraps
80106542:	e9 ac f5 ff ff       	jmp    80105af3 <alltraps>
...
80106549:	68 99 00 00 00       	push   $0x99
  jmp alltraps
8010654e:	e9 a0 f5 ff ff       	jmp    80105af3 <alltraps>
...
80106555:	68 9a 00 00 00       	push   $0x9a
  jmp alltraps
8010655a:	e9 94 f5 ff ff       	jmp    80105af3 <alltraps>
...
80106561:	68 9b 00 00 00       	push   $0x9b
  jmp alltraps
80106566:	e9 88 f5 ff ff       	jmp    80105af3 <alltraps>
...
8010656d:	68 9c 00 00 00       	push   $0x9c
  jmp alltraps
80106572:	e9 7c f5 ff ff       	jmp    80105af3 <alltraps>
...
80106579:	68 9d 00 00 00       	push   $0x9d
  jmp alltraps
8010657e:	e9 70 f5 ff ff       	jmp    80105af3 <alltraps>
...
80106585:	68 9e 00 00 00       	push   $0x9e
  jmp alltraps
8010658a:	e9 64 f5 ff ff       	jmp    80105af3 <alltraps>
...
80106591:	68 9f 00 00 00       	push   $0x9f
  jmp alltraps
80106596:	e9 58 f5 ff ff       	jmp    80105af3 <alltraps>
...
8010659d:	68 a0 00 00 00       	push   $0xa0
  jmp alltraps
801065a2:	e9 4c f5 ff ff       	jmp    80105af3 <alltraps>
...
801065a9:	68 a1 00 00 00       	push   $0xa1
  jmp alltraps
801065ae:	e9 40 f5 ff ff       	jmp    80105af3 <alltraps>
...
801065b5:	68 a2 00 00 00       	push   $0xa2
  jmp alltraps
801065ba:	e9 34 f5 ff ff       	jmp    80105af3 <alltraps>
...
801065c1:	68 a3 00 00 00       	push   $0xa3
  jmp alltraps
801065c6:	e9 28 f5 ff ff       	jmp    80105af3 <alltraps>
...
801065cd:	68 a4 00 00 00       	push   $0xa4
  jmp alltraps
801065d2:	e9 1c f5 ff ff       	jmp    80105af3 <alltraps>
...
801065d9:	68 a5 00 00 00       	push   $0xa5
  jmp alltraps
801065de:	e9 10 f5 ff ff       	jmp    80105af3 <alltraps>
...
801065e5:	68 a6 00 00 00       	push   $0xa6
  jmp alltraps
801065ea:	e9 04 f5 ff ff       	jmp    80105af3 <alltraps>
...
801065f1:	68 a7 00 00 00       	push   $0xa7
  jmp alltraps
801065f6:	e9 f8 f4 ff ff       	jmp    80105af3 <alltraps>
...
801065fd:	68 a8 00 00 00       	push   $0xa8
  jmp alltraps
80106602:	e9 ec f4 ff ff       	jmp    80105af3 <alltraps>
...
80106609:	68 a9 00 00 00       	push   $0xa9
  jmp alltraps
8010660e:	e9 e0 f4 ff ff       	jmp    80105af3 <alltraps>
...
80106615:	68 aa 00 00 00       	push   $0xaa
  jmp alltraps
8010661a:	e9 d4 f4 ff ff       	jmp    80105af3 <alltraps>
...
80106621:	68 ab 00 00 00       	push   $0xab
  jmp alltraps
80106626:	e9 c8 f4 ff ff       	jmp    80105af3 <alltraps>
...
8010662d:	68 ac 00 00 00       	push   $0xac
  jmp alltraps
80106632:	e9 bc f4 ff ff       	jmp    80105af3 <alltraps>
...
80106639:	68 ad 00 00 00       	push   $0xad
  jmp alltraps
8010663e:	e9 b0 f4 ff ff       	jmp    80105af3 <alltraps>
...
80106645:	68 ae 00 00 00       	push   $0xae
  jmp alltraps
8010664a:	e9 a4 f4 ff ff       	jmp    80105af3 <alltraps>
...
80106651:	68 af 00 00 00       	push   $0xaf
  jmp alltraps
80106656:	e9 98 f4 ff ff       	jmp    80105af3 <alltraps>
...
8010665d:	68 b0 00 00 00       	push   $0xb0
  jmp alltraps
80106662:	e9 8c f4 ff ff       	jmp    80105af3 <alltraps>
...
80106669:	68 b1 00 00 00       	push   $0xb1
  jmp alltraps
8010666e:	e9 80 f4 ff ff       	jmp    80105af3 <alltraps>
...
80106675:	68 b2 00 00 00       	push   $0xb2
  jmp alltraps
8010667a:	e9 74 f4 ff ff       	jmp    80105af3 <alltraps>
...
80106681:	68 b3 00 00 00       	push   $0xb3
  jmp alltraps
80106686:	e9 68 f4 ff ff       	jmp    80105af3 <alltraps>
...
8010668d:	68 b4 00 00 00       	push   $0xb4
  jmp alltraps
80106692:	e9 5c f4 ff ff       	jmp    80105af3 <alltraps>
...
80106699:	68 b5 00 00 00       	push   $0xb5
  jmp alltraps
8010669e:	e9 50 f4 ff ff       	jmp    80105af3 <alltraps>
...
801066a5:	68 b6 00 00 00       	push   $0xb6
  jmp alltraps
801066aa:	e9 44 f4 ff ff       	jmp    80105af3 <alltraps>
...
801066b1:	68 b7 00 00 00       	push   $0xb7
  jmp alltraps
801066b6:	e9 38 f4 ff ff       	jmp    80105af3 <alltraps>
...
801066bd:	68 b8 00 00 00       	push   $0xb8
  jmp alltraps
801066c2:	e9 2c f4 ff ff       	jmp    80105af3 <alltraps>
...
801066c9:	68 b9 00 00 00       	push   $0xb9
  jmp alltraps
801066ce:	e9 20 f4 ff ff       	jmp    80105af3 <alltraps>
...
801066d5:	68 ba 00 00 00       	push   $0xba
  jmp alltraps
801066da:	e9 14 f4 ff ff       	jmp    80105af3 <alltraps>
...
801066e1:	68 bb 00 00 00       	push   $0xbb
  jmp alltraps
801066e6:	e9 08 f4 ff ff       	jmp    80105af3 <alltraps>
...
801066ed:	68 bc 00 00 00       	push   $0xbc
  jmp alltraps
801066f2:	e9 fc f3 ff ff       	jmp    80105af3 <alltraps>
...
801066f9:	68 bd 00 00 00       	push   $0xbd
  jmp alltraps
801066fe:	e9 f0 f3 ff ff       	jmp    80105af3 <alltraps>
...
80106705:	68 be 00 00 00       	push   $0xbe
  jmp alltraps
8010670a:	e9 e4 f3 ff ff       	jmp    80105af3 <alltraps>
...
80106711:	68 bf 00 00 00       	push   $0xbf
  jmp alltraps
80106716:	e9 d8 f3 ff ff       	jmp    80105af3 <alltraps>
...
8010671d:	68 c0 00 00 00       	push   $0xc0
  jmp alltraps
80106722:	e9 cc f3 ff ff       	jmp    80105af3 <alltraps>
...
80106729:	68 c1 00 00 00       	push   $0xc1
  jmp alltraps
8010672e:	e9 c0 f3 ff ff       	jmp    80105af3 <alltraps>
...
80106735:	68 c2 00 00 00       	push   $0xc2
  jmp alltraps
8010673a:	e9 b4 f3 ff ff       	jmp    80105af3 <alltraps>
...
80106741:	68 c3 00 00 00       	push   $0xc3
  jmp alltraps
80106746:	e9 a8 f3 ff ff       	jmp    80105af3 <alltraps>
...
8010674d:	68 c4 00 00 00       	push   $0xc4
  jmp alltraps
80106752:	e9 9c f3 ff ff       	jmp    80105af3 <alltraps>
...
80106759:	68 c5 00 00 00       	push   $0xc5
  jmp alltraps
8010675e:	e9 90 f3 ff ff       	jmp    80105af3 <alltraps>
...
80106765:	68 c6 00 00 00       	push   $0xc6
  jmp alltraps
8010676a:	e9 84 f3 ff ff       	jmp    80105af3 <alltraps>
...
80106771:	68 c7 00 00 00       	push   $0xc7
  jmp alltraps
80106776:	e9 78 f3 ff ff       	jmp    80105af3 <alltraps>
...
8010677d:	68 c8 00 00 00       	push   $0xc8
  jmp alltraps
80106782:	e9 6c f3 ff ff       	jmp    80105af3 <alltraps>
...
80106789:	68 c9 00 00 00       	push   $0xc9
  jmp alltraps
8010678e:	e9 60 f3 ff ff       	jmp    80105af3 <alltraps>
...
80106795:	68 ca 00 00 00       	push   $0xca
  jmp alltraps
8010679a:	e9 54 f3 ff ff       	jmp    80105af3 <alltraps>
...
801067a1:	68 cb 00 00 00       	push   $0xcb
  jmp alltraps
801067a6:	e9 48 f3 ff ff       	jmp    80105af3 <alltraps>
...
801067ad:	68 cc 00 00 00       	push   $0xcc
  jmp alltraps
801067b2:	e9 3c f3 ff ff       	jmp    80105af3 <alltraps>
...
801067b9:	68 cd 00 00 00       	push   $0xcd
  jmp alltraps
801067be:	e9 30 f3 ff ff       	jmp    80105af3 <alltraps>
...
801067c5:	68 ce 00 00 00       	push   $0xce
  jmp alltraps
801067ca:	e9 24 f3 ff ff       	jmp    80105af3 <alltraps>
...
801067d1:	68 cf 00 00 00       	push   $0xcf
  jmp alltraps
801067d6:	e9 18 f3 ff ff       	jmp    80105af3 <alltraps>
...
801067dd:	68 d0 00 00 00       	push   $0xd0
  jmp alltraps
801067e2:	e9 0c f3 ff ff       	jmp    80105af3 <alltraps>
...
801067e9:	68 d1 00 00 00       	push   $0xd1
  jmp alltraps
801067ee:	e9 00 f3 ff ff       	jmp    80105af3 <alltraps>
...
801067f5:	68 d2 00 00 00       	push   $0xd2
  jmp alltraps
801067fa:	e9 f4 f2 ff ff       	jmp    80105af3 <alltraps>
...
80106801:	68 d3 00 00 00       	push   $0xd3
  jmp alltraps
80106806:	e9 e8 f2 ff ff       	jmp    80105af3 <alltraps>
...
8010680d:	68 d4 00 00 00       	push   $0xd4
  jmp alltraps
80106812:	e9 dc f2 ff ff       	jmp    80105af3 <alltraps>
...
80106819:	68 d5 00 00 00       	push   $0xd5
  jmp alltraps
8010681e:	e9 d0 f2 ff ff       	jmp    80105af3 <alltraps>
...
80106825:	68 d6 00 00 00       	push   $0xd6
  jmp alltraps
8010682a:	e9 c4 f2 ff ff       	jmp    80105af3 <alltraps>
...
80106831:	68 d7 00 00 00       	push   $0xd7
  jmp alltraps
80106836:	e9 b8 f2 ff ff       	jmp    80105af3 <alltraps>
...
8010683d:	68 d8 00 00 00       	push   $0xd8
  jmp alltraps
80106842:	e9 ac f2 ff ff       	jmp    80105af3 <alltraps>
...
80106849:	68 d9 00 00 00       	push   $0xd9
  jmp alltraps
8010684e:	e9 a0 f2 ff ff       	jmp    80105af3 <alltraps>
...
80106855:	68 da 00 00 00       	push   $0xda
  jmp alltraps
8010685a:	e9 94 f2 ff ff       	jmp    80105af3 <alltraps>
...
80106861:	68 db 00 00 00       	push   $0xdb
  jmp alltraps
80106866:	e9 88 f2 ff ff       	jmp    80105af3 <alltraps>
...
8010686d:	68 dc 00 00 00       	push   $0xdc
  jmp alltraps
80106872:	e9 7c f2 ff ff       	jmp    80105af3 <alltraps>
...
80106879:	68 dd 00 00 00       	push   $0xdd
  jmp alltraps
8010687e:	e9 70 f2 ff ff       	jmp    80105af3 <alltraps>
...
80106885:	68 de 00 00 00       	push   $0xde
  jmp alltraps
8010688a:	e9 64 f2 ff ff       	jmp    80105af3 <alltraps>
...
80106891:	68 df 00 00 00       	push   $0xdf
  jmp alltraps
80106896:	e9 58 f2 ff ff       	jmp    80105af3 <alltraps>
...
8010689d:	68 e0 00 00 00       	push   $0xe0
  jmp alltraps
801068a2:	e9 4c f2 ff ff       	jmp    80105af3 <alltraps>
...
801068a9:	68 e1 00 00 00       	push   $0xe1
  jmp alltraps
801068ae:	e9 40 f2 ff ff       	jmp    80105af3 <alltraps>
...
801068b5:	68 e2 00 00 00       	push   $0xe2
  jmp alltraps
801068ba:	e9 34 f2 ff ff       	jmp    80105af3 <alltraps>
...
801068c1:	68 e3 00 00 00       	push   $0xe3
  jmp alltraps
801068c6:	e9 28 f2 ff ff       	jmp    80105af3 <alltraps>
...
801068cd:	68 e4 00 00 00       	push   $0xe4
  jmp alltraps
801068d2:	e9 1c f2 ff ff       	jmp    80105af3 <alltraps>
...
801068d9:	68 e5 00 00 00       	push   $0xe5
  jmp alltraps
801068de:	e9 10 f2 ff ff       	jmp    80105af3 <alltraps>
...
801068e5:	68 e6 00 00 00       	push   $0xe6
  jmp alltraps
801068ea:	e9 04 f2 ff ff       	jmp    80105af3 <alltraps>
...
801068f1:	68 e7 00 00 00       	push   $0xe7
  jmp alltraps
801068f6:	e9 f8 f1 ff ff       	jmp    80105af3 <alltraps>
...
801068fd:	68 e8 00 00 00       	push   $0xe8
  jmp alltraps
80106902:	e9 ec f1 ff ff       	jmp    80105af3 <alltraps>
...
80106909:	68 e9 00 00 00       	push   $0xe9
  jmp alltraps
8010690e:	e9 e0 f1 ff ff       	jmp    80105af3 <alltraps>
...
80106915:	68 ea 00 00 00       	push   $0xea
  jmp alltraps
8010691a:	e9 d4 f1 ff ff       	jmp    80105af3 <alltraps>
...
80106921:	68 eb 00 00 00       	push   $0xeb
  jmp alltraps
80106926:	e9 c8 f1 ff ff       	jmp    80105af3 <alltraps>
...
8010692d:	68 ec 00 00 00       	push   $0xec
  jmp alltraps
80106932:	e9 bc f1 ff ff       	jmp    80105af3 <alltraps>
...
80106939:	68 ed 00 00 00       	push   $0xed
  jmp alltraps
8010693e:	e9 b0 f1 ff ff       	jmp    80105af3 <alltraps>
...
80106945:	68 ee 00 00 00       	push   $0xee
  jmp alltraps
8010694a:	e9 a4 f1 ff ff       	jmp    80105af3 <alltraps>
...
80106951:	68 ef 00 00 00       	push   $0xef
  jmp alltraps
80106956:	e9 98 f1 ff ff       	jmp    80105af3 <alltraps>
...
8010695d:	68 f0 00 00 00       	push   $0xf0
  jmp alltraps
80106962:	e9 8c f1 ff ff       	jmp    80105af3 <alltraps>
...
80106969:	68 f1 00 00 00       	push   $0xf1
  jmp alltraps
8010696e:	e9 80 f1 ff ff       	jmp    80105af3 <alltraps>
...
80106975:	68 f2 00 00 00       	push   $0xf2
  jmp alltraps
8010697a:	e9 74 f1 ff ff       	jmp    80105af3 <alltraps>
...
80106981:	68 f3 00 00 00       	push   $0xf3
  jmp alltraps
80106986:	e9 68 f1 ff ff       	jmp    80105af3 <alltraps>
...
8010698d:	68 f4 00 00 00       	push   $0xf4
  jmp alltraps
80106992:	e9 5c f1 ff ff       	jmp    80105af3 <alltraps>
...
80106999:	68 f5 00 00 00       	push   $0xf5
  jmp alltraps
8010699e:	e9 50 f1 ff ff       	jmp    80105af3 <alltraps>
...
801069a5:	68 f6 00 00 00       	push   $0xf6
  jmp alltraps
801069aa:	e9 44 f1 ff ff       	jmp    80105af3 <alltraps>
...
801069b1:	68 f7 00 00 00       	push   $0xf7
  jmp alltraps
801069b6:	e9 38 f1 ff ff       	jmp    80105af3 <alltraps>
...
801069bd:	68 f8 00 00 00       	push   $0xf8
  jmp alltraps
801069c2:	e9 2c f1 ff ff       	jmp    80105af3 <alltraps>
...
801069c9:	68 f9 00 00 00       	push   $0xf9
  jmp alltraps
801069ce:	e9 20 f1 ff ff       	jmp    80105af3 <alltraps>
...
801069d5:	68 fa 00 00 00       	push   $0xfa
  jmp alltraps
801069da:	e9 14 f1 ff ff       	jmp    80105af3 <alltraps>
...
801069e1:	68 fb 00 00 00       	push   $0xfb
  jmp alltraps
801069e6:	e9 08 f1 ff ff       	jmp    80105af3 <alltraps>
...
801069ed:	68 fc 00 00 00       	push   $0xfc
  jmp alltraps
801069f2:	e9 fc f0 ff ff       	jmp    80105af3 <alltraps>
...
801069f9:	68 fd 00 00 00       	push   $0xfd
  jmp alltraps
801069fe:	e9 f0 f0 ff ff       	jmp    80105af3 <alltraps>
...
80106a05:	68 fe 00 00 00       	push   $0xfe
  jmp alltraps
80106a0a:	e9 e4 f0 ff ff       	jmp    80105af3 <alltraps>
...
80106a11:	68 ff 00 00 00       	push   $0xff
  jmp alltraps
80106a16:	e9 d8 f0 ff ff       	jmp    80105af3 <alltraps>
...
80106a7a:	e8 91 dd ff ff       	call   80104810 <memset>
    *pde = V2P(pgtab) | PTE_P | PTE_W | PTE_U;
...
80106d3a:	8b 5e 10             	mov    0x10(%esi),%ebx
...
80106d5c:	8b 46 0c             	mov    0xc(%esi),%eax
...
80106dd3:	e8 38 da ff ff       	call   80104810 <memset>
...
80106e06:	5d                   	pop    %ebp
  memmove(mem, init, sz);
80106e07:	e9 a4 da ff ff       	jmp    801048b0 <memmove>
    panic("inituvm: more than a page");
80106e0c:	83 ec 0c             	sub    $0xc,%esp
80106e0f:	68 79 7c 10 80       	push   $0x80107c79
...
80106f3b:	e8 d0 d8 ff ff       	call   80104810 <memset>
...
80106f79:	68 b1 7c 10 80       	push   $0x80107cb1
...
80106fdb:	68 c9 7c 10 80       	push   $0x80107cc9
...
801070bc:	68 e5 7c 10 80       	push   $0x80107ce5
...
801070f4:	e8 17 d7 ff ff       	call   80104810 <memset>
...
80107193:	68 f6 7c 10 80       	push   $0x80107cf6
...
801071e0:	e8 cb d6 ff ff       	call   801048b0 <memmove>
...
80107279:	68 1a 7d 10 80       	push   $0x80107d1a
8010727e:	e8 0d 91 ff ff       	call   80100390 <panic>
      panic("copyuvm: pte should exist");
80107283:	83 ec 0c             	sub    $0xc,%esp
80107286:	68 00 7d 10 80       	push   $0x80107d00
...
8010730e:	e8 9d d5 ff ff       	call   801048b0 <memmove>
    len -= n;
    buf += n;
