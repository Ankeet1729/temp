  ...
  12:	bb 01 00 00 00       	mov    $0x1,%ebx
{
  ...
  24:	83 c3 01             	add    $0x1,%ebx
        setprio(i);
  27:	e8 4f 03 00 00       	call   37b <setprio>
        printf(1, "Priority : %d\n", getprio());
  2c:	e8 52 03 00 00       	call   383 <getprio>
  31:	83 c4 0c             	add    $0xc,%esp
  34:	50                   	push   %eax
  35:	68 a8 07 00 00       	push   $0x7a8
  3a:	6a 01                	push   $0x1
  3c:	e8 ff 03 00 00       	call   440 <printf>
    for(int i=1; i<10; i++){
  41:	83 c4 10             	add    $0x10,%esp
  44:	83 fb 0a             	cmp    $0xa,%ebx
  47:	75 d7                	jne    20 <main+0x20>
    }
    exit();
  49:	e8 65 02 00 00       	call   2b3 <exit>
  4e:	66 90                	xchg   %ax,%ax
...
printf(int fd, const char *fmt, ...)
{
 ...
 5c4:	eb 1a                	jmp    5e0 <printf+0x1a0>
          s = "(null)";
 5c6:	bb b7 07 00 00       	mov    $0x7b7,%ebx
        while(*s != 0){
...
free(void *ap)
{
 ...
 615:	a1 6c 0a 00 00       	mov    0xa6c,%eax
{
 ...
 636:	73 10                	jae    648 <free+0x38>
{
 ...
 661:	5b                   	pop    %ebx
  freep = p;
 662:	a3 6c 0a 00 00       	mov    %eax,0xa6c
}
 667:	5e                   	pop    %esi
 668:	5f                   	pop    %edi
 669:	5d                   	pop    %ebp
...
malloc(uint nbytes)
{
 ...
 6ad:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 6b0:	8b 3d 6c 0a 00 00    	mov    0xa6c,%edi
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
